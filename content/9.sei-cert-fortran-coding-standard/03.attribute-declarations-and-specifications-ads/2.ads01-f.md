...
-   Enforces data flow discipline. It requires that all dummy arguments of a function have `intent(in)` (or `value` ) and that subroutines have explicit intents for all arguments, reducing the risk of unintended data modifications.
