...
When choosing a source code analysis tool, it is clearly desirable that the tool be able to enforce as many of the guidelines in the standard as possible. Not all recommendations are enforceable; some are strictly meant to be informative.
...
![](attachments/87152332/88024401.png) Possibilities for a Given Guideline
...
![](images/icons/bullet_blue.gif) [fn_and_fp_chart.JPG](/attachments/87152332/88031258.jpg){target="_blank"} (image/jpeg)  
![](images/icons/bullet_blue.gif) [C_Intro_ToolSelect.png](/attachments/87152332/88020501.png){target="_blank"} (image/png)  
![](images/icons/bullet_blue.gif) [image2016-8-2 9:20:46.png](/attachments/87152332/88024401.png){target="_blank"} (image/png)  
