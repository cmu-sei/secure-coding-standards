...
You can create a unique URL to get more information on CWEs by appending the relevant ID to the end of a fixed string. For example, to find more information about CWE-192, Integer Coercion Error,” you can append 192.html to `https://cwe.mitre.org/data/definitions` and enter the resulting URL in your browser: [https://cwe.mitre.org/data/definitions/192.html](https://cwe.mitre.org/data/definitions/192.html) .
