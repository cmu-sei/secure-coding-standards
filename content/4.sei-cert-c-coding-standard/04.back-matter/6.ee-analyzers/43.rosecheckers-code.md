...
The [SEI CERT C Secure Coding Standard](https://wiki.sei.cmu.edu/confluence/spaces/c/overview) is freely available.
...
![](images/icons/bullet_blue.gif) [c_rules.zip](/attachments/87152336/88020500.zip){target="_blank"} (application/zip)  
