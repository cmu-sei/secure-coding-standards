...
For a discussion of this programming error in the Common Weakness Enumeration database, see [CWE-119](https://cwe.mitre.org/data/definitions/119.html) , "Improper Restriction of Operations within the Bounds of a Memory Buffer," and [CWE-121](https://cwe.mitre.org/data/definitions/121.html) , "Stack-based Buffer Overflow" \[ [MITRE 2013](/sei-cert-c-coding-standard/back-matter/aa-bibliography#AA.Bibliography-MITRE) \].
...
For a discussion of this programming error in the Common Weakness Enumeration database, see [CWE-122](https://cwe.mitre.org/data/definitions/122.html) , "Heap-based Buffer Overflow," and [CWE-129](https://cwe.mitre.org/data/definitions/129.html) , "Improper Validation of Array Index" \[ [MITRE 2013](/sei-cert-c-coding-standard/back-matter/aa-bibliography#AA.Bibliography-MITRE) \].
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/axivion-suite">Axivion Suite</a> | <div class="content-wrapper">7.12.0</div> | **CertC-ARR30** | Can detect out-of-bound access to array / buffer |
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **LANG.MEM.BO** <br />  **LANG.MEM.BU** <br />  **LANG.MEM.TBA**  <br /> **LANG.MEM.TO** <br /> **LANG.MEM.TULANG.STRUCT.PARITH** <br />  **LANG.STRUCT.PBB** <br /> **LANG.STRUCT.PPE** <br />  **BADFUNC.BO.*** | Buffer overrun <br /> Buffer underrun <br /> Tainted buffer access <br /> Type overrun <br /> Type underrun <br /> Pointer Arithmetic <br /> Pointer before beginning of object <br /> Pointer past end of object <br /> A collection of warning classes that report uses of library functions prone to internal buffer overflows. |
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/cppcheck">Cppcheck</a> | <div class="content-wrapper">2.15</div> | **arrayIndexOutOfBounds, outOfBounds, negativeIndex, arrayIndexThenCheck, arrayIndexOutOfBoundsCond,  possibleBufferAccessOutOfBounds** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/cppcheck-premium">Cppcheck Premium</a> | <div class="content-wrapper">24.11.0</div> | **arrayIndexOutOfBounds, outOfBounds, negativeIndex, arrayIndexThenCheck, arrayIndexOutOfBoundsCond,  possibleBufferAccessOutOfBounds** <br /> **premium-cert-arr30-c** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/helix-qac">Helix QAC</a> | <div class="content-wrapper">2025.2</div> | **C2840** <br /> **DF2820, DF2821, DF2822, DF2823, DF2840, DF2841, DF2842, DF2843, DF2930, DF2931, DF2932, DF2933, DF2935, DF2936, DF2937, DF2938, DF2950, DF2951, DF2952, DF2953** |  |
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/ldra">LDRA tool suite</a> | <div class="content-wrapper">9.7.1</div> | **45 D, 47 S, 476 S, 489 S, 64 X, 66 X, 68 X, 69 X, 70 X, 71 X** **, 79 X** | Partially implemented |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2026.1</div> | **CERT_C-ARR30-a** | Avoid accessing arrays out of bounds |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft Insure++</a> |  |  | Runtime analysis |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/pc-lint-plus">PC-lint Plus</a> | <div class="content-wrapper">1.4</div> | **413, 415, 416, 613, 661, 662, 676** | Fully supported |
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/pvs-studio">PVS-Studio</a> | <div class="content-wrapper">7.43</div> | <a href="https://pvs-studio.com/en/docs/warnings/v512/">**V512**</a> , <a href="https://pvs-studio.com/en/docs/warnings/v557/">**V557**</a> , <a href="https://pvs-studio.com/en/docs/warnings/v582/">**V582**</a> , <a href="https://pvs-studio.com/en/docs/warnings/v594/">**V594**</a> , <a href="https://pvs-studio.com/en/docs/warnings/v643/">**V643**</a> , <a href="https://pvs-studio.com/en/docs/warnings/v645/">**V645**</a> , **<a href="https://pvs-studio.com/en/docs/warnings/v694/">V694</a>** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/rulechecker">RuleChecker</a> | <div class="content-wrapper">25.10</div> | **array-index-range-constant** <br /> **return-reference-local** <br /> **csa-stack-address-escape (C++)** | Partially checked |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **arrayIndexOutOfBoundsCond** <br /> **assignmentInAssert** <br /> **autoVariables** <br /> **autovarInvalidDeallocation** <br /> **C01** <br /> **C02** <br /> **C03** <br /> **C04** <br /> **C05** <br /> **C06** <br /> **C07** <br /> **C08** <br /> **C08** <br /> **C09** <br /> **C10** <br /> **C49** | Fully Implemented |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/trustinsoft-analyzer">TrustInSoft Analyzer</a> | <div class="content-wrapper">1.38</div> | **index_in_address** | Exhaustively verified (see <a href="https://taas.trust-in-soft.com/tsnippet/t/3a7bd506">one compliant and one non-compliant example</a>). |


### Related Vulnerabilities

[CVE-2008-1517](https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2008-1517) results from a violation of this rule. Before Mac OSX version 10.5.7, the XNU kernel accessed an array at an unverified user-input index, allowing an attacker to execute arbitrary code by passing an index greater than the length of the array and therefore accessing outside memory \[ [xorl 2009](https://xorl.wordpress.com/2009/06/09/cve-2008-1517-apple-mac-os-x-xnu-missing-array-index-validation/) \].
...
| [CWE 2.11](https://cwe.mitre.org/data/index.html)                                                                    | [CWE-119](https://cwe.mitre.org/data/definitions/119.html) , Improper Restriction of Operations within the Bounds of a Memory Buffer | 2017-05-18: CERT: Rule subset of CWE                |
