...
## <a id="ARR30C.Donotformoruseoutofboundspointersorarraysubscripts-NullPointerArithmetic"></a> Noncompliant Code Example (Null Pointer Arithmetic)
  ...
  This noncompliant code example is similar to an [Adobe Flash Player vulnerability](https://www.zerodayinitiative.com/advisories/ZDI-08-032/) that was first exploited in 2008. This code allocates a block of memory and initializes it with some data. The data does not belong at the beginning of the block, which is left uninitialized. Instead, it is placed `offset` bytes within the block. The function ensures that the data fits within the allocated block.
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/ldra">LDRA tool suite</a> | <div class="content-wrapper">10.6.0</div> | **45 S, 141 D, 47 S, 476 S, 489 S, 692 S, 64 X, 66 X, 68 X, 69 X, 70 X, 71 X, 79 X** | Statically implemented |
...
|  |  |
| --- | --- |
| \[ [Finlay 2003](/sei-cert-c-coding-standard/back-matter/aa-bibliography#AA.Bibliography-Finlay03) \] |  |
| \[ [Microsoft 2003](/sei-cert-c-coding-standard/back-matter/aa-bibliography#AA.Bibliography-Microsoft03) \] |  |
| \[ [Pethia 2003](/sei-cert-c-coding-standard/back-matter/aa-bibliography#AA.Bibliography-Pethia03) \] |  |
| \[ [Seacord 2013b](/sei-cert-c-coding-standard/back-matter/aa-bibliography#AA.Bibliography-Seacord2013) \] | Chapter 1, "Running with Scissors" |
| \[ [Viega 2005](/sei-cert-c-coding-standard/back-matter/aa-bibliography#AA.Bibliography-Viega05) \] | Section 5.2.13, "Unchecked Array Indexing" |
| \[ [xorl 2009](/sei-cert-c-coding-standard/back-matter/aa-bibliography#AA.Bibliography-xorl2009) \] | ["CVE-2008-1517: Apple Mac OS X (XNU) Missing Array Index Validation"](https://xorl.wordpress.com/2009/06/09/cve-2008-1517-apple-mac-os-x-xnu-missing-array-index-validation/) |
