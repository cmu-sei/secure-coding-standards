...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.1p0</div> | **BADFUNC.ATOF** <br /> **BADFUNC.ATOI** <br /> **BADFUNC.ATOL** <br /> **BADFUNC.ATOLL** <br /> **(customization)** | Use of atof <br /> Use of atoi <br /> Use of atol <br /> Use of atoll <br /> Users can add custom checks for uses of other undesirable conversion functions. |
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2025.2</div> | **CERT_C-ERR34-a** | The 'atof', 'atoi', 'atol' and 'atoll' functions from the 'stdlib.h' or 'cstdlib' library should not be used |
