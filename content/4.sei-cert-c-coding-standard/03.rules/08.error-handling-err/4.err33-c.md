...
In this noncompliant code example, `snprintf()` is assumed to succeed. However, if the call fails (for example, because of insufficient memory, as described in GNU libc bug [441945](https://bugzilla.redhat.com/show_bug.cgi?id=441945) ), the subsequent call to `log_message()` has [undefined behavior 174](/sei-cert-c-coding-standard/back-matter/cc-undefined-behavior#CC.UndefinedBehavior-ub_174) because the character buffer is uninitialized and need not be null-terminated.
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **LANG.FUNCS.IRV** <br /> **LANG.ERRCODE.NOTEST** <br /> **LANG.ERRCODE.NZ** | Ignored return value <br /> Missing Test of Error Code <br /> Non-zero Error Code |
...
| [CWE 2.11](https://cwe.mitre.org/data/index.html)                                                               | [CWE-252](https://cwe.mitre.org/data/definitions/252.html) , Unchecked Return Value                                                                                                                                                                                  | 2017-07-06: CERT: Partial overlap                   |
| [CWE 2.11](https://cwe.mitre.org/data/index.html)                                                               | [CWE-253](https://cwe.mitre.org/data/definitions/253.html) , Incorrect Check of Function Return Value                                                                                                                                                                | 2017-07-06: CERT: Partial overlap                   |
| [CWE 2.11](https://cwe.mitre.org/data/index.html)                                                               | [CWE-391](https://cwe.mitre.org/data/definitions/391.html) , Unchecked Error Condition                                                                                                                                                                               | 2017-07-06: CERT: Rule subset of CWE                |
