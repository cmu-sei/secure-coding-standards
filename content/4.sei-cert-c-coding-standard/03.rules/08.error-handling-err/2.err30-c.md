...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/astree">Astrée</a> | <div class="content-wrapper">25.10</div> | **chained-errno-function-calls** <br /> **errno-reset** <br /> **errno-test-after-wrong-call** | Partially checked |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/axivion-suite">Axivion Suite</a> | <div class="content-wrapper">7.12.0</div> | **CertC-ERR30** | Fully implemented |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **LANG.STRUCT.RC** | Redundant Condition |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/rose">Compass/ROSE</a> |  |  | Could detect violations of this rule by ensuring that each library function is accompanied by the proper treatment of <code>       errno      </code> |
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/cppcheck-premium">Cppcheck Premium</a> | <div class="content-wrapper">24.11.0</div> | **premium-cert-err30-c** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/helix-qac">Helix QAC</a> | <div class="content-wrapper">2025.2</div> | **C2500, C2501, C2502, C2503** <br /> **C++3172, C++3173, C++3174, C++3175, C++3176, C++3177, C++3178, C++3179, C++3183, C++3184** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/klocwork">Klocwork</a> | <div class="content-wrapper">2025.2</div> | **CXX.ERRNO.NOT_SET** <br /> **CXX.ERRNO.NOT_CHECKED** <br /> **CXX.ERRNO.INCORRECTLY_CHECKED** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/ldra">LDRA tool suite</a> | <div class="content-wrapper">9.7.1</div> | **111 D, 121 D, 122 D, 132  D, 134 D** | Fully implemented |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2026.1</div> | **CERT_C-ERR30-a** | Properly use errno value |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/polyspace-bug-finder">Polyspace Bug Finder</a> | <div class="content-wrapper">R2025b</div> | <a href="https://www.mathworks.com/help/bugfinder/ref/certcruleerr30c.html">CERT C: Rule ERR30-C</a> | Checks for:<ul><li>Misuse of errno</li><li>Errno not reset</li></ul>Rule fully covered. |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/rulechecker">RuleChecker</a> | <div class="content-wrapper">25.10</div> | **chained-errno-function-calls** <br /> **errno-test-after-wrong-call** | Partially checked |
...
| [CWE 2.11](https://cwe.mitre.org/data/index.html)                                                               | [CWE-456](https://cwe.mitre.org/data/definitions/456.html) , Missing Initialization of a Variable                           | 2017-07-05: CERT: Rule subset of CWE                |
