...
It is important to note that local data can be used securely with threads when using other thread interfaces, so the programmer need not always copy data into nonlocal memory when sharing data with threads. For example, the `shared` keyword in *[The OpenMP <sup>®</sup> API Specification for Parallel Programming](https://openmp.org/wp/)* \[ [OpenMP](https://openmp.org/wp/) \] can be used in combination with OpenMP's threading interface to share local memory without having to worry about whether local automatic variables remain valid.
...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/astree">Astrée</a> | <div class="content-wrapper">25.10</div> | **thread-resource-storage-duration** | Partially checked + soundly supported |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/axivion-suite">Axivion Suite</a> | <div class="content-wrapper">7.12.0</div> | **CertC-CON34** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **CONCURRENCY.LOCALARG** <br /> **CONCURRENCY.C_THREAD.ISD** | Local Variable Passed to Thread <br /> Inappropriate Storage Duration |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/cppcheck-premium">Cppcheck Premium</a> | <div class="content-wrapper">24.11.0</div> | **premium-cert-con34-c** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/helix-qac">Helix QAC</a> | <div class="content-wrapper">2025.2</div> | **DF4926, DF4927, DF4928** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2026.1</div> | **CERT_C-CON34-a** | Declare objects shared between POSIX threads with appropriate storage durations |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/polyspace-bug-finder">Polyspace Bug Finder</a> | <div class="content-wrapper">R2025b</div> | <a href="https://www.mathworks.com/help/bugfinder/ref/certcrulecon34c.html">CERT C: Rule CON34-C</a> | Checks for automatic or thread local variable escaping from a C11 thread (rule fully covered) |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/rulechecker">RuleChecker</a> | <div class="content-wrapper">25.10</div> | **thread-resource-storage-duration** | Partially checked |
...
| \[ [OpenMP](/sei-cert-c-coding-standard/back-matter/aa-bibliography#AA.Bibliography-OpenMP) \]                      | *[The OpenMP <sup>®</sup> API Specification for Parallel Programming](https://openmp.org/wp/)* |
