...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **CONCURRENCY.DU** | Double Unlock |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/helix-qac">Helix QAC</a> | <div class="content-wrapper">2025.2</div> | **DF4971, DF4972, DF4981, DF4982** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2026.1</div> | **CERT_C-POS48-a** <br /> **CERT_C-POS48-b** | Do not destroy another thread's mutexDo not release a lock that has not been acquired |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/polyspace-bug-finder">Polyspace Bug Finder</a> | <div class="content-wrapper">R2025b</div> | <a href="https://www.mathworks.com/help/bugfinder/ref/certcrulepos48c.html">CERT C: Rule POS48-C</a> | Checks for destruction of locked mutex (rule fully covered) |


### Related Vulnerabilities

Search for vulnerabilities resulting from the violation of this rule on the [CERT website](https://www.kb.cert.org/vuls/search/?q=POS31-C) .
...
| [CWE 2.11](https://cwe.mitre.org/data/index.html) | [CWE-667](https://cwe.mitre.org/data/definitions/667.html) , Insufficient locking | 2017-07-10: CERT: Rule subset of CWE |
