...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2026.1</div> | **CERT_C-POS50-a** | Declare objects shared between POSIX threads with appropriate storage durations |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/polyspace-bug-finder">Polyspace Bug Finder</a> | <div class="content-wrapper">R2025b</div> | <a href="https://www.mathworks.com/help/bugfinder/ref/certcrulepos50c.html">CERT C: Rule POS50-C</a> | Checks for automatic or thread local variable escaping from a POSIX thread (rule fully covered) |


##  Bibliography

<table class="wrapped"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td>[ <a href="https://www.securecoding.cert.org/confluence/display/seccode/AA.+References">Bryant 2003</a> ]</td><td>Chapter 13, "Concurrent Programming"</td></tr><tr class="even"><td>[ <a href="https://openmp.org/wp/">OpenMP</a> ]</td><td><br />
</td></tr></tbody></table>
