...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2025.2</div> | **CERT_C-POS53-a** | Do not use more than one mutex for concurrent waiting operations on a condition variable |
