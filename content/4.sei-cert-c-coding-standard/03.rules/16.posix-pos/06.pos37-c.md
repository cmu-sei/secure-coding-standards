...
Search for vulnerabilities resulting from the violation of this rule on the [CERT website](https://www.kb.cert.org/vuls/search/?q=POS37-C) .
...
| [CWE 2.11](https://cwe.mitre.org/data/index.html)                                                               | [CWE-273](https://cwe.mitre.org/data/definitions/273.html) , Failure to check whether privileges were dropped successfully | 2017-07-07: CERT: Exact                             |
