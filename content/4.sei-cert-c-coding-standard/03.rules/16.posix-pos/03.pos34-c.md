...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.1p0</div> | **(customization)** <br /> **BADFUNC.PUTENV** | Users can add a custom check for all uses of <code>putenv()</code>. <br /> Use of putenv |
