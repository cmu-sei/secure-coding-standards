...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/axivion-suite">Axivion Suite</a> | <div class="content-wrapper">7.12.0</div> | **CertC-POS30** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **LANG.MEM.BO** <br /> **LANG.MEM.TBA** <br /> **MISC.MEM.NTERM.CSTRING** | Buffer Overrun <br /> Tainted Buffer Access <br /> Unterminated C String |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/rose">Compass/ROSE</a> |  |  |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/coverity">Coverity</a> | <div class="content-wrapper">2017.07</div> | **READLINK** | Implemented |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/helix-qac">Helix QAC</a> | <div class="content-wrapper">2025.2</div> | **C5033** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/klocwork">Klocwork</a> | <div class="content-wrapper">2025.2</div> | <div class="content-wrapper">**ABV.GENERAL** <br /> **ABV.GENERAL.MULTIDIMENSION**</div> |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2026.1</div> | **CERT_C-POS30-a** <br /> **CERT_C-POS30-b** <br /> **CERT_C-POS30-c** | Avoid overflow due to reading a not zero terminated string <br /> The values returned by functions 'read' and 'readlink' shall be used <br /> Use of possibly not null-terminated string with functions expecting null-terminated string |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/polyspace-bug-finder">Polyspace Bug Finder</a> | <div class="content-wrapper">R2025b</div> | <a href="https://www.mathworks.com/help/bugfinder/ref/certcrulepos30c.html">CERT C: Rule POS30-C</a> | Checks for misuse of readlink() (rule partially covered) |


## Related Vulnerabilities

Search for vulnerabilities resulting from the violation of this rule on the [CERT website](https://www.kb.cert.org/vuls/search/?q=POS30-C) .
...
| [CWE 2.11](https://cwe.mitre.org/data/index.html) | [CWE-170](https://cwe.mitre.org/data/definitions/170.html) , Improper null termination | 2017-06-13: CERT: Rule subset of CWE |
