...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.1p0</div> | **LANG.MEM.BO** <br /> **LANG.MEM.TBA** <br /> **MISC.MEM.NTERM.CSTRING** | Buffer Overrun <br /> Tainted Buffer Access <br /> Unterminated C String |
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2025.2</div> | **CERT_C-POS30-a** <br /> **CERT_C-POS30-b** <br /> **CERT_C-POS30-c** | Avoid overflow due to reading a not zero terminated string <br /> The values returned by functions 'read' and 'readlink' shall be used <br /> Use of possibly not null-terminated string with functions expecting null-terminated string |
