...
| --- | --- | --- | --- | --- | --- | --- |
| FIO34-C | High | Probable | Yes | Yes | <span style="color: #e74c3c;">**P18**</span> | <span style="color: #e74c3c;">**L1**</span> |
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/ldra">LDRA tool suite</a> | <div class="content-wrapper">10.6.0</div> | **662 S** | Fully implemented |
...
Search for [vulnerabilities](/sei-cert-c-coding-standard/back-matter/bb-definitions#BB.Definitions-vulnerability) resulting from the violation of this rule on the [CERT website](https://www.kb.cert.org/vuls/search/?q=FIO34-C) .
