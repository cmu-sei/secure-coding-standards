...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **BADFUNC.BO.*** | A collection of checks that report uses of library functions prone to internal buffer overflows. |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2026.1</div> | **CERT_C-API02-a** <br /> **CERT_C-API02-b** | Avoid using unsafe string functions which may cause buffer overflows <br /> Don't use unsafe C functions that do write to range-unchecked buffers |
