...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.1p0</div> | **BADFUNC.BO.*** | A collection of checks that report uses of library functions prone to internal buffer overflows. |
