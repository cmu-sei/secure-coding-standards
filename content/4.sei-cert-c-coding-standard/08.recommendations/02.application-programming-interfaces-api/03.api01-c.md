...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2025.2</div> | **CERT_C-API01-a** <br /> **CERT_C-API01-b** | Avoid overflow when writing to a buffer <br /> Avoid using unsafe string functions which may cause buffer overflows |
