...
|  |  |
| --- | --- |
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-59](https://cwe.mitre.org/data/definitions/59.html) , Failure to resolve links before file access (aka "link following") <br> [CWE-362](https://cwe.mitre.org/data/definitions/362.html) , Concurrent Execution using Shared Resource with Improper Synchronization ('Race Condition') <br> [CWE-367](https://cwe.mitre.org/data/definitions/367.html) , Time-of-check, time-of-use (TOCTOU) race condition |
