...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/rose">Compass/ROSE</a> |  |  | Could report possible violations of this rule by flagging calls to <code>open()</code> that do not have an <code>O_NOFOLLOW</code> flag and that are not preceded by a call to <code>lstat()</code> and succeeded by a call to <code>fstat</code> |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **RTOS_19** | Fully implemented |


### Related Vulnerabilities

Search for vulnerabilities resulting from the violation of this rule on the [CERT website](https://www.kb.cert.org/vuls/search/?q=POS01-C) .

## Related Guidelines

<table class="wrapped"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td><a href="https://cwe.mitre.org/">MITRE CWE</a></td><td><a href="https://cwe.mitre.org/data/definitions/59.html">CWE-59</a> , Failure to resolve links before file access (aka "link following")<br />
<a href="https://cwe.mitre.org/data/definitions/362.html">CWE-362</a> , Concurrent Execution using Shared Resource with Improper Synchronization ('Race Condition')<br />
<a href="https://cwe.mitre.org/data/definitions/367.html">CWE-367</a> , Time-of-check, time-of-use (TOCTOU) race condition</td></tr></tbody></table>
