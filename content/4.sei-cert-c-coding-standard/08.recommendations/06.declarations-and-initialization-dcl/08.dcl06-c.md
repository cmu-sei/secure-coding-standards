...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/axivion-suite">Axivion Suite</a> | <div class="content-wrapper">7.12.0</div> | **CertC-DCL06** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.1p0</div> | **LANG.STRUCT.SW.SWNEE** | Switch with non-enum expression |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/rose">Compass/ROSE</a> |  |  | Could detect violations of this recommendation merely by searching for the use of "magic numbers" and magic strings in the code itself. That is, any number (except a few canonical numbers: −1, 0, 1, 2) that appears in the code anywhere besides where assigned to a variable is a magic number and should instead be assigned to a <code>const</code> integer, enum, or macro. Likewise, any string literal (except <code>""</code> and individual characters) that appears in the code anywhere besides where assigned to a <code>char*</code> or <code>char[]</code> is a magic string |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/eclair">ECLAIR</a> | <div class="content-wrapper">1.2</div> | **CC2.DCL06** | Fully implemented |
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/klocwork">Klocwork</a> | <div class="content-wrapper">2025.2</div> | **CERT.LITERAL.INT.CONST** <br /> **CERT.LITERAL.FLT.CONST** <br /> **CERT.LITERAL.STR.CONST** <br /> **CERT.LITERAL.CHAR.CONST** <br /> **CERT.LITERAL.BITFIELD** <br /> **CERT.LITERAL.ARRAY** |  |
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2025.2</div> | **CERT_C-DCL06-a** | Use meaningful symbolic constants to represent literal values |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/polyspace-bug-finder">Polyspace Bug Finder</a> | <div class="content-wrapper">R2025b</div> | <a href="https://www.mathworks.com/help/bugfinder/ref/certcrec.dcl06c.html">CERT C: Rec. DCL06-C</a> | Checks for:<ul><li>Hard-coded buffer size</li><li>Hard-coded loop boundary</li></ul>Rec. fully covered. |
