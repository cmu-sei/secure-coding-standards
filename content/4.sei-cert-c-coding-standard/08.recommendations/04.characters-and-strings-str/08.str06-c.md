...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.1p0</div> | **(customization)** | Users who wish to avoid using <code>strtok()</code> entirely can add a custom check for all uses of <code>strtok()</code> . |
