...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/ldra">LDRA tool suite</a> | <div class="content-wrapper">10.6.0</div> | **602 S** | Implemented and enhanced |
...
Search for vulnerabilities resulting from the violation of this rule on the [CERT website](https://www.kb.cert.org/vuls/search/?q=STR06-C) .

## Related Guidelines

|                                                                |                                                                                                                                                                                                                                                                  |
|----------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [MITRE CWE](https://cwe.mitre.org/)                             | [CWE-464](https://cwe.mitre.org/data/definitions/464.html) , Addition of data structure sentinel                                                                                                                                                                  |

## Bibliography

|                                                                                                     |                                                                                  |
|-----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| \[ [Linux 2008](/sei-cert-c-coding-standard/back-matter/aa-bibliography#AA.Bibliography-Linux08) \] | [strtok(3)](https://www.kernel.org/doc/man-pages/online/pages/man3/strtok.3.html) |
