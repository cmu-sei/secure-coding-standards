...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/ldra">LDRA tool suite</a> | <div class="content-wrapper">10.6.0</div> | **176 S, 376 S** | Statically implemented |
...
| --- | --- |
|  |  |
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-176](https://cwe.mitre.org/data/definitions/176.html) , Failure to handle Unicode encoding <br> [CWE-116](https://cwe.mitre.org/data/definitions/116.html) , Improper encoding or escaping of output |
