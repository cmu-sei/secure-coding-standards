...
|  |  |
| --- | --- |
| [CERT Oracle Secure Coding Standard for Java](https://www.securecoding.cert.org/confluence/display/java/The+CERT+Oracle+Secure+Coding+Standard+for+Java) | [VNA03-J. Do not assume that a group of calls to independently atomic methods is atomic](/sei-cert-oracle-coding-standard-for-java/rules/visibility-and-atomicity-vna/vna03-j) <br> [VNA04-J. Ensure that calls to chained methods are atomic](/sei-cert-oracle-coding-standard-for-java/rules/visibility-and-atomicity-vna/vna04-j) |
