...
This compliant solution uses a Microsoft Windows critical section object to make operations involving `account_balance` atomic \[ [MSDN](https://msdn.microsoft.com/en-us/library/windows/desktop/ms682530(v=vs.85).aspx) \].
...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **LANG.TYPE.IVD** | Inappropriate volatile declaration |
...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2026.1</div> | CERT_C-CON02-a | Do not use the volatile keyword |
