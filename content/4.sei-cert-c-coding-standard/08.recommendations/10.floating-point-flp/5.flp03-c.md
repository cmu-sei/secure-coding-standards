...
| --- | --- |
| Linux<br /><br />Solaris 10<br /><br />AIX 5.3<br /><br />HP-UX 11.31<br /><br />Mac OS X 10.5 | Use the C floating-point exception functions |
| Windows | Use either the C floating-point exception functions or structured exception handling through `_fpieee_flt` [ [MSDN](/sei-cert-c-coding-standard/back-matter/aa-bibliography#AA.Bibliography-MSDN) ] |
