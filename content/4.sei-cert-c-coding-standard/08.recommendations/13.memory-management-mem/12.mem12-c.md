...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/ldra">LDRA tool suite</a> | <div class="content-wrapper">10.6.0</div> | **50 D** | Statically implemented |
...
|  |  |
| --- | --- |
|  | Dijkstra, Edgar, ["Go To Statement Considered Harmful.](https://homepages.cwi.nl/~storm/teaching/reader/Dijkstra68.pdf) ", 1968 |
| [Linux Kernel Sourcecode (v2.6.xx)](https://www.kernel.org/pub/linux/kernel/v2.6) | 2.6.29, `kernel/fork.c` , the `copy_process()` Function |
