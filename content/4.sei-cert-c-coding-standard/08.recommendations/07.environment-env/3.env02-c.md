...
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-462](https://cwe.mitre.org/data/definitions/462.html) , Duplicate key in associative list (Alist) <br> [CWE-807](https://cwe.mitre.org/data/definitions/807.html) , Reliance on untrusted inputs in a security decision |
