...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.1p0</div> | **IO.TAINT.FNAME** | Tainted Filename |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/rose">Compass/ROSE</a> |  |  | Could catch violations of this rule by enforcing that any call to <code>open()</code> or <code>fopen()</code> is preceded by a canonicalization routine—that is, a call to <code>realpath()</code> or <code>canonicalize_file_name()</code> . This call will catch some false positives, as ROSE cannot tell when canonicalization is warranted. False positives can be reduced (but not eliminated) by only reporting instances of <code>fopen()</code> or <code>open()</code> where the file name string has some other processing done to it. This reflects the fact that canonicalization is only necessary for doing verification based on the file name string |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/helix-qac">Helix QAC</a> | <div class="content-wrapper">2025.2</div> | **C5047** <br /> **C1611** <br /> **C1612** <br /> **C1613** <br /> **C3519** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/klocwork">Klocwork</a> | <div class="content-wrapper">2025.2</div> | **SV.DLLPRELOAD.NONABSOLUTE.DLL** <br /> **SV.TOCTOU.FILE_ACCESS** |  |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/ldra">LDRA tool suite</a> | <div class="content-wrapper">9.7.1</div> | **85 D** | Partially implemented |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/polyspace-bug-finder">Polyspace Bug Finder</a> | <div class="content-wrapper">R2025b</div> | <a href="https://www.mathworks.com/help/bugfinder/ref/certcrec.fio02c.html">CERT C: Rec. FIO02-C</a> | Checks for vulnerable path manipulation (rule fully covered) |
