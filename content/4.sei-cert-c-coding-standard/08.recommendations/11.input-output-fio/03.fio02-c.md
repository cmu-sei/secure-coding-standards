...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/ldra">LDRA tool suite</a> | <div class="content-wrapper">10.6.0</div> | **85 D** | Statically implemented |
...
| --- | --- |
|  |  |
| [CERT Oracle Secure Coding Standard for Java](/sei-cert-oracle-coding-standard-for-java/) | [FIO16-J. Canonicalize path names before validating them](/sei-cert-oracle-coding-standard-for-java/rules/input-output-fio/fio16-j) |
...
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-22](https://cwe.mitre.org/data/definitions/22.html) , Path traversal <br> [CWE-23](https://cwe.mitre.org/data/definitions/23.html) , Relative Path Traversal <br> [CWE-28](https://cwe.mitre.org/data/definitions/28.html) , Path Traversal: '..\filedir' <br> [CWE-40](https://cwe.mitre.org/data/definitions/40.html) , Path Traversal: '\\UNC\share\name\' (Windows UNC Share) <br> [CWE-41](https://cwe.mitre.org/data/definitions/41.html) , Failure to resolve path equivalence <br> [CWE-59](https://cwe.mitre.org/data/definitions/59.html) , Failure to resolve links before file access (aka "link following") <br> [CWE-73](https://cwe.mitre.org/data/definitions/73.html) , External control of file name or path |
