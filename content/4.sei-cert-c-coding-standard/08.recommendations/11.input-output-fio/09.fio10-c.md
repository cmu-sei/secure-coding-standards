...
On Windows, the [`rename()`](https://msdn.microsoft.com/en-us/library/zw5t957f(VS.80).aspx) function fails if a
...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **(customization)** | Users can add a custom check for all uses of <code>rename()</code> . |
...
| \[ [MSDN](/sei-cert-c-coding-standard/back-matter/aa-bibliography#AA.Bibliography-MSDN) \]                                                     | [`rename()`](https://msdn.microsoft.com/en-us/library/zw5t957f%28VS.80%29.aspx) |
