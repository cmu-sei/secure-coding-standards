...
| --- | --- | --- | --- | --- | --- | --- |
| FIO20-C | Medium | Likely | No | Yes | <span style="color: #e74c3c;">**P12**</span> | <span style="color: #e74c3c;">**L1**</span> |
...
Search for [vulnerabilities](/sei-cert-c-coding-standard/back-matter/bb-definitions#BB.Definitions-vulnerability) resulting from the violation of this rule on the [CERT website](https://www.kb.cert.org/vuls/search/?q=FIO20-C) .
