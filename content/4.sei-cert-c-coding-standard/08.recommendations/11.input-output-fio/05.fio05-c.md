...
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-37](https://cwe.mitre.org/data/definitions/37.html) , Path issue—Slash absolute path <br> [CWE-38](https://cwe.mitre.org/data/definitions/38.html) , Path Issue—Backslash absolute path <br> [CWE-39](https://cwe.mitre.org/data/definitions/39.html) , Path Issue—Drive letter or Windows volume <br> [CWE-62](https://cwe.mitre.org/data/definitions/62.html) , UNIX hard link <br> [CWE-64](https://cwe.mitre.org/data/definitions/64.html) , Windows shortcut following (.LNK) <br> [CWE-65](https://cwe.mitre.org/data/definitions/65.html) , Windows hard link |
