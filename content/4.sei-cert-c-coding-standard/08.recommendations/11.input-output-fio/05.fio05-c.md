...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/rose">Compass/ROSE</a> |  |  | Could report possible violations of this rule merely by reporting any <code>open()</code> or <code>fopen()</code> call that did not have a subsequent call to <code>fstat()</code> |
