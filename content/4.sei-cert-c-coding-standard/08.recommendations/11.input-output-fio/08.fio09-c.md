...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/rose">Compass/ROSE</a> |  |  | Could flag possible violations of this rule by noting any pointer to <code>struct</code> that is passed to <code>fread()</code> , as the noncompliant code example demonstrates |
