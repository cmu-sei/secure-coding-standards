...
| --- | --- |
|  |  |
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-379](https://cwe.mitre.org/data/definitions/379.html) , Creation of temporary file in directory with insecure permissions <br> [CWE-552](https://cwe.mitre.org/data/definitions/552.html) , Files or directories accessible to external parties |
