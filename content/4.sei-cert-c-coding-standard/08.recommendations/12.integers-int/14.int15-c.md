...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2026.1</div> | **CERT_C-INT15-a** | Use intmax_t or uintmax_t for formatted IO on programmer-defined integer types |
...
|                                                                |                                                                                                                                                                                                                                                                                        |
|----------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [MITRE CWE](https://cwe.mitre.org/)                             | [CWE-681](https://cwe.mitre.org/data/definitions/681.html) , Incorrect conversion between numeric types                                                                                                                                                                                 |
