...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2025.2</div> | **CERT_C-INT08-a** <br /> **CERT_C-INT08-b** <br /> **CERT_C-INT08-c** <br /> **CERT_C-INT08-d** | Avoid data loss when converting between integer types <br /> Avoid signed integer overflows <br /> Avoid value change when converting between integer types <br /> Avoid wraparounds when performing arithmetic integer operations |
