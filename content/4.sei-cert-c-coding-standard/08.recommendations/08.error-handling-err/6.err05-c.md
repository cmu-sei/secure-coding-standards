...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2025.2</div> | **CERT_C-ERR05-a** <br /> **CERT_C-ERR05-b** <br /> **CERT_C-ERR05-c** | The 'abort()' function from the 'stdlib.h' or 'cstdlib' library shall not be used <br /> The 'exit()' function from the 'stdlib.h' or 'cstdlib' library shall not be used <br /> The 'quick_exit()' and '_Exit()' functions from the 'stdlib.h' or 'cstdlib' library shall not be u |
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **C32C33** | Fully implemented |
