...
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2026.1</div> | **CERT_C-ERR05-a** <br /> **CERT_C-ERR05-b** <br /> **CERT_C-ERR05-c** | The 'abort()' function from the 'stdlib.h' or 'cstdlib' library shall not be used <br /> The 'exit()' function from the 'stdlib.h' or 'cstdlib' library shall not be used <br /> The 'quick_exit()' and '_Exit()' functions from the 'stdlib.h' or 'cstdlib' library shall not be u |
...
Search for vulnerabilities resulting from the violation of this rule on the [CERT website](https://www.kb.cert.org/vuls/search/?q=ERR05-C) .
