...
If you are participating in the [OurCS Workshop](http://www.cs.cmu.edu/ourcs/register.html) , you must add the following text box (with your name added) to every wiki page you modify or create. Add this text box to the top of the page, just below the title.
