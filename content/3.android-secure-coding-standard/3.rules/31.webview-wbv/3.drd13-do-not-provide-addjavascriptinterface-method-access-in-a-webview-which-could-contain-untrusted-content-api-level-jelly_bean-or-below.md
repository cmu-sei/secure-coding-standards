...
| --- | --- | --- | --- | --- | --- | --- |
| DRD13-J | High | Probable | No | No | <span style="color: #f1c40f;">P6</span> | <span style="color: #f1c40f;">L2</span> |
...
|-----------|----------|---------|-------------|
| <a href="/android-secure-coding-standard/back-matter/bb-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | <div class="content-wrapper">**JAVA.JS.RI**</div> | Risky JavaScript interface (Java) |
...
|                                                                                                                                   |                                                                                             |
|-----------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| \[ [Android API 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-AndroidAPI13) \] | [class WebView](https://developer.android.com/reference/android/webkit/WebView.html)         |
| \[ [Android API 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-AndroidAPI13) \] | [\<uses-sdk>](https://developer.android.com/guide/topics/manifest/uses-sdk-element.html#min) |
