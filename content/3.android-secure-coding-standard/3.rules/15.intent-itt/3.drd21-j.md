...
| --- | --- | --- | --- | --- | --- | --- |
| DRD21-J | Medium | Probable | Yes | No | <span style="color: #27ae60;">P4</span> | <span style="color: #27ae60;">L3</span> |
...
|                                                                                                                               |                                                                                                             |
|-------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
| \[ [Android API 2013](https://www.securecoding.cert.org/confluence/display/java/AA.+References#AA.References-AndroidAPI13) \] | [class `PendingIntent`](https://developer.android.com/reference/android/app/PendingIntent.html) |
