...
The [Geolocation API](https://www.w3.org/TR/geolocation-API/) , which is specified by W3C, enables web browsers to access geographical location information of a user's device.
...
| --- | --- | --- | --- | --- | --- | --- |
| DRD15-J | Low | Probable | No | No | <span style="color: #27ae60;">P2</span> | <span style="color: #27ae60;">L3</span> |
...
|                                                                 |                                         |
|-----------------------------------------------------------------|-----------------------------------------|
| [Geolocation API](https://www.w3.org/TR/geolocation-API/) by W3C | <https://www.w3.org/TR/geolocation-API/> |
...
|                                                                                                                               |                                                                                                                                                                                                                                                                                                        |
|-------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| \[ [Android API 2013](https://www.securecoding.cert.org/confluence/display/java/AA.+References#AA.References-AndroidAPI13) \] | [class `WebChromeClient`](https://developer.android.com/reference/android/webkit/WebChromeClient.html) [,](https://developer.android.com/reference/android/content/Context.html) [class `WebSettings`](https://developer.android.com/reference/android/webkit/WebSettings.html) |
| \[ [W3C 2013](https://www.securecoding.cert.org/confluence/display/java/AA.+References#AA.References-W3C13) \]                | [Geolocation API Specification](https://www.w3.org/TR/geolocation-API/)                                                                                                                                                                                                                                 |
