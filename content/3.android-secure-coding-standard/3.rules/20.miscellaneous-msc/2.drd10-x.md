...
| --- | --- | --- | --- | --- | --- | --- |
| DRD10-X | High | Probable | Yes | Yes | <span style="color: #e74c3c;">P18</span> | <span style="color: #e74c3c;">L1</span> |
...
Search for [vulnerabilities](#) resulting from the violation of this rule on the [CERT website](https://www.kb.cert.org/vuls/search/?q=DRD10-x) .
