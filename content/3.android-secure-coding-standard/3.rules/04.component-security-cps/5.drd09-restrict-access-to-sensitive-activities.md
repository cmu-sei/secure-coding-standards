...
|  |  |
| --- | --- |
| *[Android Secure Design / Secure Coding Guidebook](http://www.jssec.org/dl/android_securecoding_en.pdf)* by JSSEC | 4.1.1.1 Creating/using private activities<br>4.1.3.1. Combining exported attributes and and intent filter settings (for activities)<br>4.1.3.2. Validating the requesting application |
