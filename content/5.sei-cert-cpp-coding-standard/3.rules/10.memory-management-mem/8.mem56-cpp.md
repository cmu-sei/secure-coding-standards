...
|  |  |
| --- | --- |
| [SEI CERT C++ Coding Standard](/sei-cert-cpp-coding-standard/) | [MEM50-CPP. Do not access freed memory](/sei-cert-cpp-coding-standard/rules/memory-management-mem/mem50-cpp)<br>[MEM51-CPP. Properly deallocate dynamically allocated resources](/sei-cert-cpp-coding-standard/rules/memory-management-mem/mem51-cpp) |
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-415](https://cwe.mitre.org/data/definitions/415.html) , Double Free<br>[CWE-416](https://cwe.mitre.org/data/definitions/416.html) , Use After Free<br>[CWE 762](https://cwe.mitre.org/data/definitions/762.html) , Mismatched Memory Management Routines |
