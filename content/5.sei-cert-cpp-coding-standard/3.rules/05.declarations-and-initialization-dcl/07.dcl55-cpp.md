...
| <a href="/sei-cert-cpp-coding-standard/back-matter/cc-analyzers/parasoft">Parasoft C/C++test</a> | <div class="content-wrapper">2025.2</div> | **CERT_CPP-DCL55-a** | A pointer to a structure should not be passed to a function that can copy data to the user space |
