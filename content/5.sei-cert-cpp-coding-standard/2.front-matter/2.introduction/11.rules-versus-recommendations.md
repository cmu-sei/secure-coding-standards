...
CERT coding standards consist of *rules* and *recommendations* . Rules are meant to provide normative requirements for code; recommendations are meant to provide guidance that, when followed, should improve the safety, [reliability](/sei-cert-cpp-coding-standard/back-matter/bb-definitions#BB.Definitions-reliability) , and security of software systems. However, a violation of a recommendation does not necessarily indicate the presence of a defect in the code. Rules and recommendations are collectively referred to as *guidelines* .
