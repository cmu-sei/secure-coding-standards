...
2.  These rules and recommendations are edited by members of the CERT technical staff for content and style and placed on the [CERT Secure Coding Standards website](https://www.securecoding.cert.org) for comment and review.
