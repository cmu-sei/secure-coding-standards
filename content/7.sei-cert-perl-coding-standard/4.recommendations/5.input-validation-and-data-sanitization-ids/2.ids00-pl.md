...
| --- | --- | --- |
| Taint mode | Insecure dependency in .*open | Detects only files open for writing. Does not detect files open only for reading. |
| [Security Reviewer - Static Reviewer](/sei-cert-perl-coding-standard/back-matter/bb-analyzers/security-reviewer-static-reviewer) | PERL_S91 PERL_S32 |  |
