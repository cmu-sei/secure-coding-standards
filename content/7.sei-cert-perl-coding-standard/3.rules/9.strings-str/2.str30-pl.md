...
Perl's capture variables ( `$1` , `$2` , etc.) are assigned the values of capture expressions after a regular expression (regex) match has been found. If a regex fails to find a match, the contents of the capture variables can remain undefined. The [perlre](https://perldoc.perl.org/perlre.html) manpage \[ [Wall 2011](/sei-cert-perl-coding-standard/back-matter/aa-bibliography#AA.Bibliography-Manpages) \] contains this note:
...
| --- | --- | --- | --- | --- | --- | --- |
| STR30-PL | Medium | Probable | Yes | No | <span style="color: #f1c40f;">**P8**</span> | <span style="color: #f1c40f;">**L2**</span> |
...
| \[ [Wall 2011](/sei-cert-perl-coding-standard/back-matter/aa-bibliography#AA.Bibliography-Manpages) \] | [perlre](https://perldoc.perl.org/perlre.html)                                                                                                                                                                                                              |
