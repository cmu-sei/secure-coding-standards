...
**STR31-PL-EX0** : A string literal may be passed to a function if it normally takes a regex pattern but provides special behavior for that string. For example, the [perlfunc](https://perldoc.perl.org/perlfunc.html) manpage \[ [Wall 2011](/sei-cert-perl-coding-standard/back-matter/aa-bibliography#AA.Bibliography-Manpages) \] says, regarding `PATTERN` , the first argument to `split()` :
...
| --- | --- | --- | --- | --- | --- | --- |
| STR31-PL | Low | Likely | Yes | Yes | <span style="color: #f1c40f;">**P9**</span> | <span style="color: #f1c40f;">**L2**</span> |
