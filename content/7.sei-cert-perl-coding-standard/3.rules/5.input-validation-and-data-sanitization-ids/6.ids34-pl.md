...
The [perlfunc](https://perldoc.perl.org/perlfunc.html) manpages states, regarding all but the first two arguments to `open()` :
...
[US-CERT Vulnerability #583020](https://www.kb.cert.org/vuls/id/583020) describes Perl code that invoked the `system()` built-ig function without sanitizing its argument:
...
|                                                                                                        |                                                                             |
|--------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
| \[ [VU#583020](https://www.kb.cert.org/vuls/id/583020) \]                                               | [XMMS Remote input validation error](https://www.kb.cert.org/vuls/id/583020) |
| \[ [Wall 2011](/sei-cert-perl-coding-standard/back-matter/aa-bibliography#AA.Bibliography-Manpages) \] | [perlfunc](https://perldoc.perl.org/perlfunc.html)                           |
