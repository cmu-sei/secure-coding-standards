...
This noncompliant code example demonstrates an XSS exploit. This code uses the [CGI](http://search.cpan.org/dist/CGI/) module to display a web form and is adopted from an example from the [CGI.pm documentation](https://cpansearch.perl.org/src/MARKSTOS/CGI.pm-3.59/cgi_docs.html#functionvsoo) . The form queries the user for a name and displays the resulting name on the page when the user clicks `Submit` .
...
|                                                                                                        |                                                                                                                                                                                |
|--------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| \[ [Birznieks 1998](https://gunther.web66.com/FAQS/taintmode.html) \]                                   | Birznieks, Gunther, [CGI/Perl Taint Mode FAQ,](https://gunther.web66.com/FAQS/taintmode.html) Version 1.0, June 3, 1998                                                         |
| \[ [CGI 2005](https://cpansearch.perl.org/src/MARKSTOS/CGI.pm-3.59/cgi_docs.html#functionvsoo) \]       | CGI.pm: A Perl5 CGI Library, [Function-Oriented vs Object-Oriented Use](https://cpansearch.perl.org/src/MARKSTOS/CGI.pm-3.59/cgi_docs.html#functionvsoo)                        |
...
| \[Lester 2006\]                                                                                        | Lester, Andy, " [Perl's taint mode to the rescue](https://www.oreillynet.com/onlamp/blog/2006/11/perls_taint_mode_to_the_rescue.html) ," O'Reilly OULamp.com, November 17, 2006 |
| \[ [VU#246409](https://www.kb.cert.org/vuls/id/246409) \]                                               | [Input validation error in quikstore.cgi allows attackers to execute commands](https://www.kb.cert.org/vuls/id/246409)                                                          |
| \[ [VU#282403](https://www.kb.cert.org/vuls/id/282403) \]                                               | [AdCycle does not adequately validate user input thereby allowing for SQL injection](https://www.kb.cert.org/vuls/id/282403)                                                    |
| \[ [Wall 2011](/sei-cert-perl-coding-standard/back-matter/aa-bibliography#AA.Bibliography-Manpages) \] | [perlsec](https://perldoc.perl.org/perlsec.html)                                                                                                                                |
