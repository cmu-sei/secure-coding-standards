...
When choosing a compiler (which should be understood to include the linker), a compiler that complies with the Java Language Specification \[ [JLS 2005](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-JLS05) \] should be used whenever possible.
...
A static analysis tool is considered complete (with respect to a specific guideline) if it does not give a false-negative result, meaning it is able to find all violations of a guideline.
...
The possibilities for a given guideline are outlined in the table below.

![](attachments/88487590/88873866.jpg)
...
![](images/icons/bullet_blue.gif) [fn_and_fp_chart.JPG](/attachments/88487590/88873866.jpg){target="_blank"} (image/jpeg)  
