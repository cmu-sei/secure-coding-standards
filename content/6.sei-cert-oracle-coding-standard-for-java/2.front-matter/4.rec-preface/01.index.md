...
The Secure Coding Standard for Java rules are also available on CERT's secure coding pages at <https://www.securecoding.cert.org/confluence/display/java/The+CERT+Oracle+Secure+Coding+Standard+for+Java>, where they continue to evolve. *The CERT <sup>®</sup> Oracle <sup>®</sup> Secure Coding Standard for Java* provides the definition of the rules for conformance testing purposes, but these pages may contain additional information or insights not included in the book that may help you interpret the meaning of these rules.
