...
| --- | --- | --- | --- | --- | --- | --- |
| ENV05-J | High | Probable | No | No | <span style="color: #f1c40f;">**P6**</span> | <span style="color: #f1c40f;">**L2**</span> |
...
[CVE-2010-4495](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2010-4495) describes a [vulnerability](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-bb-glossary) in the TIBCO ActiveMatrix product line in which a flaw in JMX connection processing allowed remote users to execute arbitrary code, cause denial of service, or obtain potentially sensitive information.
