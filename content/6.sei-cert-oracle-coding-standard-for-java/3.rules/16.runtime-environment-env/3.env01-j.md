...
| --- | --- | --- | --- | --- | --- | --- |
| ENV01-J | High | Probable | No | No | <span style="color: #f1c40f;">**P6**</span> | <span style="color: #f1c40f;">**L2**</span> |
...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **JAVA.INSEC.LDAP.DA** | LDAP authentication disabled (Java) |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **AvoidPrivilegedActions** | Full Implementation |
...
|                                    |                                                                                                                       |
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-349](https://cwe.mitre.org/data/definitions/349.html) , Acceptance of Extraneous Untrusted Data with Trusted Data |

## Bibliography

|  |  |
| --- | --- |
| \[ [EMA 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-EMA14) \] | Extension Mechanism Architecture, ["Optional Package Sealing"](https://docs.oracle.com/javase/7/docs/technotes/guides/extensions/spec.html#sealing) |
| \[ [McGraw 1999](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Ware99) \] | Rule 7, If you must sign your code, put it all in one archive file |
