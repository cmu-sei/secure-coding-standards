...
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **IncorrectAssembly** | Full Implementation |
...
|                                                                                                                                            |                                                                                                                                               |
|--------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| [Secure Coding Guidelines for the Java Programming Language, Version 3.0](https://www.oracle.com/technetwork/java/seccodeguide-139067.html) | Guideline 6-3. Safely invoke standard APIs that bypass `SecurityManager` checks depending on the immediate caller's class loader |
...
|                                                                                                                          |                                                                                                                                                                                                                     |
|--------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| \[ [CVE 2011](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-CVE08) \]       | [CVE-2009-0783](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2009-0783)                                                                                                                                        |
...
| \[ [Tomcat 2009](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Tomcat09) \] | [Bug ID 29936](https://issues.apache.org/bugzilla/show_bug.cgi?id=29936) , API Class `org.apache.tomcat.util.digester.Digester` , [Security fix in v 6.0.20](https://tomcat.apache.org/security-6.html) |
