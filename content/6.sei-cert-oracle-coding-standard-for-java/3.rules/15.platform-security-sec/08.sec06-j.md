...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-c-coding-standard/back-matter/ee-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.0p0</div> | **JAVA.IO.INJ.ANDROID.MESSAGE** <br /> **JAVA.IO.TAINT.MESSAGE** | Android Message Injection (Java) <br /> Tainted Message (Java) |
