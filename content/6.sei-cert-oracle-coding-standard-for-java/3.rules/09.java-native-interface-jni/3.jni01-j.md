...
| --- | --- | --- | --- | --- | --- | --- |
| JNI01-J | high | likely | No | No | <span style="color: #f1c40f;">P9</span> | <span style="color: #f1c40f;">L2</span> |
...
| [Secure Coding Guidelines for Java SE, Version 5.0](https://www.oracle.com/technetwork/java/seccodeguide-139067.html#9-9) | Guideline 9-9. Safely invoke standard APIs that perform tasks using the immediate caller's class loader instance |
