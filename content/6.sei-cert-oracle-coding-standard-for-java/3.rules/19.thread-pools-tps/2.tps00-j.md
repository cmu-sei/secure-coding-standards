...
|  |  |
| --- | --- |
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-405](https://cwe.mitre.org/data/definitions/405.html) , Asymmetric Resource Consumption (Amplification)<br>[CWE-410](https://cwe.mitre.org/data/definitions/410.html) , Insufficient Resource Pool |
