...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.TPS00.ISTART** | Do not call the 'start()' method directly on Thread class instances |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **ScheduledThreadPoolExecutor** | Full Implementation |


## Related Guidelines

<table class="wrapped"><tbody><tr class="odd"><td><p><a href="https://cwe.mitre.org/">MITRE CWE</a></p></td><td><p><a href="https://cwe.mitre.org/data/definitions/405.html">CWE-405</a> , Asymmetric Resource Consumption (Amplification)<br />
<a href="https://cwe.mitre.org/data/definitions/410.html">CWE-410</a> , Insufficient Resource Pool</p></td></tr></tbody></table>

## Bibliography

|  |  |
| --- | --- |
| \[ [API 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-API14) \] | [Interface `Executor`](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/Executor.html) |
| \[ [Goetz 2006a](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Goetz06) \] | Chapter 8, "Applying Thread Pools" |
| \[ [Java Tutorials](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JavaTutorials) \] | [Thread Pools](https://java.sun.com/docs/books/tutorial/essential/concurrency/pools.html) |
| \[ [Lea 2000a](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Lea00) \] | Section 4.1.3, "Thread-Per-Message" Section 4.1.4, "Worker Threads" |
