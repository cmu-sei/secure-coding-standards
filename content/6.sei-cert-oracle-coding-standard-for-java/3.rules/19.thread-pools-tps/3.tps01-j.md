...
|  |  |
| --- | --- |
| \[ [API 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-API14) \] | [Class `CallerRunsPolicy`](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ThreadPoolExecutor.CallerRunsPolicy.html) |
| \[ [Gafter 2006](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Gafter06) \] | [A Thread Pool Puzzler](http://gafter.blogspot.com/2006/11/thread-pool-puzzler.html) |
| \[ [Goetz 2006](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Goetz06) \] | Section 5.3.3, "Dequeues and Work Stealing" Section 8.3.2, "Managing Queued Tasks" Section 8.3.3, "Saturation Policies" |
