...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.0p0</div> | **JAVA.ALLOC.LEAK.NOTSTORED** <br /> **JAVA.CLASS.UI** | Closeable not stored (Java) <br /> Inefficient instantiation (Java) |
