...
The Apache Geronimo bug described by [GERONIMO-4224](https://issues.apache.org/jira/browse/GERONIMO-4224) results in an `OutOfMemoryError` exception thrown by the `WebAccessLogViewer` when the access log file size is too large.

## Automated Detection

| Tool      | Version  | Checker | Description |
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **JAVA.ALLOC.LEAK.NOTSTORED** <br /> **JAVA.CLASS.UI** | Closeable not stored (Java) <br /> Inefficient instantiation (Java) |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **AvoidStringBuildLoop** | Full Implementation |


##  Related Guidelines

<table class="wrapped"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td><p><a href="/sei-cert-c-coding-standard/">SEI CERT C Coding Standard</a></p></td><td><p><a href="/sei-cert-c-coding-standard/recommendations/memory-management-mem/mem11-c">MEM11-C. Do not assume infinite heap space</a></p></td></tr><tr class="even"></tr><tr class="odd"><td><a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-ISO/IECTR24772-2010">ISO/IEC TR 24772:2010</a></td><td><p>Resource Exhaustion [XZP]</p></td></tr><tr class="even"><td><p><a href="https://cwe.mitre.org/">MITRE CWE</a></p></td><td><p><a href="https://cwe.mitre.org/data/definitions/400.html">CWE-400</a> , Uncontrolled Resource Consumption ("Resource Exhaustion")<br />
...
|  |  |
| --- | --- |
| \[ [API 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-API14) \] | [Class `ObjectInputStream`](https://docs.oracle.com/javase/8/docs/api/java/io/ObjectInputStream.html) [Class `ObjectOutputStream`](https://docs.oracle.com/javase/8/docs/api/java/io/ObjectOutputStream.html) |
| \[ [Java 2006](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Java06) \] | [Java—The Java Application Launcher](https://java.sun.com/javase/6/docs/technotes/tools/windows/java.html) , Syntax for Increasing the Heap Size |
| \[ [Oracle 2015](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Oracle) \] | [Tuning the Java Runtime System](https://docs.oracle.com/cd/E26576_01/doc.312/e24936/tuning-java.htm#GSPTG00006) |
| \[ [SDN 2008](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-SDN08) \] | [Serialization FAQ](https://java.sun.com/javase/technologies/core/basic/serializationFAQ.jsp) |
| \[ [Sun 2006](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Sun06) \] | [Garbage Collection Ergonomics](https://java.sun.com/javase/6/docs/technotes/guides/vm/gc-ergonomics.html) , Default Values for the Initial and Maximum Heap Size |
