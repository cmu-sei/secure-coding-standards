...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.MSC04.LEAKS** | Ensure resources are deallocated |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **MemoryLeakObjectOutputStream** | Full Implementation |
...
| [MITRE CWE](https://cwe.mitre.org/)                                                                                                      | [CWE-401](https://cwe.mitre.org/data/definitions/401.html) , Improper Release of Memory before Removing Last Reference ("Memory Leak") |

## Bibliography

|  |  |
| --- | --- |
| \[ [API 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-API14) \] | [Class `Vector`](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html) [Class `WeakReference`](https://docs.oracle.com/javase/8/docs/api/java/lang/ref/WeakReference.html) |
| \[ [Bloch 2008](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Bloch08) \] | Item 6, "Eliminate Obsolete Object References" |
| \[ [Commes 2007](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Commes07) \] | "Memory Leak Avoidance" |
| \[ [Goetz 2005a](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Goetz05) \] | "Lapsed Listeners" |
| \[ [Gupta 2005](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Gupts05) \] |  |
