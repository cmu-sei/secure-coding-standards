...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/the-checker-framework">The Checker Framework</a> | <div class="content-wrapper">2.1.3</div> | **Linear Checker** | Control aliasing and prevent re-use (see Chapter 19) |
| Coverity | 7.5 | **SINGLETON_RACE** <br /> **UNSAFE_LAZY_INIT** <br /> **FB.LI_LAZY_INIT_UPDATE_STATIC** <br /> **FB.LI_LAZY_INIT_STATIC** | Implemented |
| Parasoft Jtest | <div class="content-wrapper">2026.1</div> | **CERT.MSC07.ILI** | Make lazy initializations thread-safe |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **InstantiatedLoop** | Full Implementation |
...
|                                    |                                                                                                                                         |
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-543](https://cwe.mitre.org/data/definitions/543.html) , Use of Singleton Pattern without Synchronization in a Multithreaded Context |

## Bibliography

|  |  |
| --- | --- |
| \[ [Bloch 2008](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Bloch08) \] | Item 3, "Enforce the Singleton Property with a Private Constructor or an `enum` Type" Item 77, "For Instance Control, Prefer `enum` Types to `readResolve` " |
| \[ [Daconta 2003](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Daconta03) \] | Item 15, "Avoiding Singleton Pitfalls" |
| \[ [Darwin 2004](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Darwin04) \] | Section 9.10, "Enforcing the Singleton Pattern" |
| \[ [Fox 2001](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Fox01) \] | [When Is a Singleton Not a Singleton?](https://java.sun.com/developer/technicalArticles/Programming/singletons/) |
| \[ [Gamma 1995](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Gamma95) \] | Singleton |
| \[ [Grand 2002](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Grand02) \] | Chapter 5, "Creational Patterns," section "Singleton" |
