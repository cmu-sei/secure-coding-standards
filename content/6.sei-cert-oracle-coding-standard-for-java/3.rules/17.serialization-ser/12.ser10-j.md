...
|  |  |
| --- | --- |
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-400](https://cwe.mitre.org/data/definitions/400.html) , Uncontrolled Resource Consumption (aka "Resource Exhaustion")<br>[CWE-770](https://cwe.mitre.org/data/definitions/770.html) , Allocation of Resources without Limits or Throttling |
