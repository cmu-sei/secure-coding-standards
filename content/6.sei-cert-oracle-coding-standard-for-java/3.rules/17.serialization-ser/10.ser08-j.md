...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **DangerousClassRMI** | Full Implementation |
...
|                                    |                                                                                                   |
|------------------------------------|---------------------------------------------------------------------------------------------------|
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-250](https://cwe.mitre.org/data/definitions/250.html) , Execution with Unnecessary Privileges |
...
</p></td></tr><tr class="even"><td><p>[ <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-CVE08">CVE 2011</a> ]</p></td><td><p><a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-5353">CVE-2008-5353</a></p></td></tr></tbody></table>
