...
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.SER07.RRSC** | Define a "readResolve" method for all instances of Serializable types |
...
|                                                                                                                      |                                                                                                 |
|----------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| [MITRE CWE](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-MITRE09)      | [CWE-502](https://cwe.mitre.org/data/definitions/502.html) , "Deserialization of Untrusted Data" |
| [Secure Coding Guidelines for Java SE, Version 5.0](https://www.oracle.com/technetwork/java/seccodeguide-139067.html) | Guideline 8-3 / SERIAL-3: View deserialization the same as object construction                  |

## Bibliography

|  |  |
| --- | --- |
| \[ [API 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-API14) \] | [Class `Object`](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html) [Class `Hashtable`](https://docs.oracle.com/javase/8/docs/api/java/util/Hashtable.html) |
| \[ [Bloch 2008](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Bloch08) \] | Item 75, "Consider Using a Custom Serialized Form" |
| \[ [Greanier 2000](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Greanier00) \] |  |
| \[ [Harold 2006](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Harold16) \] | Chapter 11, "Object Serialization" |
| \[ [Hawtin 2008](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Hawtin08) \] | Antipattern 8, "Believing Deserialisation Is Unrelated to Construction" |
| \[ [Rapid7 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Rapid714) \] | Metasploit: [Java AtomicReferenceArray Type Violation Vulnerability](https://www.rapid7.com/db/modules/exploit/multi/browser/java_atomicreferencearray) |
