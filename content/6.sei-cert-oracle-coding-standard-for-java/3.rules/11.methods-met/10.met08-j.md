...
|  |  |
| --- | --- |
| \[ [API 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-API14) \] | [Class `URI`](https://docs.oracle.com/javase/8/docs/api/) [ Class `URL`](https://docs.oracle.com/javase/8/docs/api/) (method `equals()` ) |
| \[ [Bloch 2008](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Bloch08) \] | Item 8, "Obey the General Contract When Overriding `equals` " |
| \[ [Cline, C++ Super-FAQ](https://isocpp.org/wiki/faq/proper-inheritance) \] |  |
| \[ [Darwin 2004](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Darwin04) \] | Section 9.2, "Overriding the `equals` Method" |
| \[ [Harold 1997](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Harold97) \] | Chapter 3, "Classes, Strings, and Arrays," section "The Object Class (Equality)" |
| [Liskov 1994] | [Liskov, B. H.](https://en.wikipedia.org/wiki/Barbara_Liskov) ; [Wing, J. M.](https://en.wikipedia.org/wiki/Jeannette_Wing) (November 1994). *A behavioral notion of subtyping* . *[ACM Trans. Program. Lang. Syst.](https://en.wikipedia.org/wiki/ACM_Transactions_on_Programming_Languages_and_Systems)* **16** (6). pp. 1811–1841. [doi](https://en.wikipedia.org/wiki/Digital_object_identifier) : [10.1145/197320.197383](https://doi.org/10.1145%2F197320.197383) . An updated version appeared as CMU technical report: [Liskov, Barbara](https://en.wikipedia.org/wiki/Barbara_Liskov) ; [Wing, Jeannette](https://en.wikipedia.org/wiki/Jeannette_Wing) (July 1999). ["Behavioral Subtyping Using Invariants and Constraints"](http://reports-archive.adm.cs.cmu.edu/anon/1999/CMU-CS-99-156.ps) ( [PS](https://en.wikipedia.org/wiki/PostScript) ) . |
| \[ [Sun 2006](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Sun06) \] | [Determining If Two Keys Are Equal](https://java.sun.com/javase/6/docs/technotes/guides/security/crypto/CryptoSpec.html#Determining%20If%20Two%20Keys%20Are%20Equal) (JCA Reference Guide) |
| \[ [Techtalk 2007](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Techtalk07) \] | "More Joy of Sets" |
