...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.MET06.CLONE** | Make your 'clone()' method "final" for security |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/spotbugs">SpotBugs</a> | <div class="content-wrapper">4.6.0</div> | **MC_OVERRIDABLE_METHOD_CALL_IN_CLONE** | Implemented (since 4.5.0) |
...
|  |  |
| --- | --- |
| \[ [Bloch 2008](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Bloch08) \] | Item 11, "Override `clone` Judiciously" |
| \[ [Gong 2003](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Gong03) \] |  |
