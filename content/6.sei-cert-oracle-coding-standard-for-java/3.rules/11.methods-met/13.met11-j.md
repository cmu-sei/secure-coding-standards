...
|  |  |
| --- | --- |
| \[ [API 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-API06) \] | [Class](https://docs.oracle.com/javase/8/docs/api/java/util/Hashtable.html) `Hashtable&lt;K,V&gt; java.util.Interface Set&lt;E&gt;` `java.util.Interface Map&lt;K,V&gt;` |
