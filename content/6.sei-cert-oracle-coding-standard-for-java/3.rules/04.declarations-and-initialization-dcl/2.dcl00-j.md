...
According to *The Java Language Specification* (JLS), [§12.4, "Initialization of Classes and Interfaces"](https://java.sun.com/docs/books/jls/third_edition/html/execution.html#12.4) \[ [JLS 2005](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JLS05) \]:
...
The JLS also states in [§8.3.2.1, "Initializers for Class Variables"](https://java.sun.com/docs/books/jls/third_edition/html/classes.html#8.3.2.1) \[ [JLS 2005](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JLS05) \]:
...
Step 3 of the detailed initialized procedure described in JLS [§12.4.2](https://docs.oracle.com/javase/specs/jls/se8/html/jls-12.html#jls-12.4.2) \[ [JLS 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JLS14) \] permits implementations to ignore the possibility of such recursive initialization cycles.
...
| --- | --- | --- | --- | --- | --- | --- |
| DCL00-J | Low | Unlikely | Yes | No | <span style="color: #27ae60;">**P2**</span> | <span style="color: #27ae60;">**L3**</span> |

## Automated Detection

| Tool      | Version  | Checker | Description |
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **JAVA.STRUCT.SE.ASSERT** <br /> **JAVA.STRUCT.UA** <br /> **JAVA.STRUCT.UA.DEFAULT** | Assertion contains side effects <br /> Useless assignment <br /> Useless assignment to default |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.DCL00.ACD** | Ensure that files do not contain cyclical dependencies |
