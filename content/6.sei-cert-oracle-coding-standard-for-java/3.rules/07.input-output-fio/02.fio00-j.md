...
| --- | --- | --- | --- | --- | --- | --- |
| FIO00-J | Medium | Unlikely | No | No | <span style="color: #27ae60;">**P2**</span> | <span style="color: #27ae60;">**L3**</span> |

## Automated Detection

| Tool      | Version  | Checker | Description |
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **AbsoluteResource** | Full Implementation |
...
| [MITRE CWE](https://cwe.mitre.org/)                         | [CWE-67](https://cwe.mitre.org/data/definitions/67.html) , Improper Handling of Windows Device Names                                             |
...
|  |  |
| --- | --- |
| \[ [API 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-API14) \] | [Class `FileLock`](https://docs.oracle.com/javase/8/docs/api/java/nio/channels/FileLock.html) Methods `createTempFile` Method `delete` Method `deleteOnExit` |
| \[ [Darwin 2004](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Darwin04) \] | Section 11.5, "Creating a Transient File" |
| \[ [Garfinkel 1996](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Garfinkel96) \] | Section 5.6, "Device Files" |
| \[ [Howard 2002](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Howard02) \] | Chapter 11, "Canonical Representation Issues" |
| \[ [J2SE 2011](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-J2SE11) \] | "The `try` -with-resources Statement" |
| \[ [JDK Bug 2015](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JDKBug) \] | Bug [JDK-4171239](https://bugs.openjdk.java.net/browse/JDK-4171239) Bug [JDK-4405521](https://bugs.openjdk.java.net/browse/JDK-4405521) Bug [JDK-4631820](https://bugs.openjdk.java.net/browse/JDK-4631820) |
| \[ [Open Group 2004](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-OpenGroup04) \] | [`open()`](http://www.opengroup.org/onlinepubs/009695399/functions/open.html) |
| \[ [Secunia 2008](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Secunia08) \] | [Secunia Advisory 20132](https://secunia.com/advisories/20132/) |
