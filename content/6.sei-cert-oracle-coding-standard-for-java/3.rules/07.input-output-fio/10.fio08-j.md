...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.FIO08.CRRV** | Check the return value of methods which read or skip input |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/spotbugs">SpotBugs</a> | <div class="content-wrapper">4.6.0</div> | **EOS_BAD_END_OF_STREAM_CHECK** | Implemented (since 4.4.0) |
...
| \[ [JLS 2005](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JLS05) \]   | [§4.2 "Primitive Types and Values"](https://docs.oracle.com/javase/specs/jls/se8/html/jls-4.html#jls-4.2) |
