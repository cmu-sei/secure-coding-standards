...
| --- | --- | --- | --- | --- | --- | --- |
| FIO05-J | Medium | Likely | No | No | <span style="color: #f1c40f;">**P6**</span> | <span style="color: #f1c40f;">**L2**</span> |
...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.FIO05.BUFEXP** | Do not expose data wrapped by a buffer to untrusted code |
