...
|  |  |
| --- | --- |
| \[ [API 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-API14) \] | [Class `ByteBuffer`](https://docs.oracle.com/javase/8/docs/api/java/nio/ByteBuffer.html) Method `wrap()` Method `order()` [Class `Integer`](https://docs.oracle.com/javase/8/docs/api/java/lang/Integer.html) Method `reverseBytes()` |
| \[ [Cohen 1981](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Cohen81) \] | "On Holy Wars and a Plea for Peace" |
| \[ [Harold 1997](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Harold97) \] | Chapter 2, "Primitive Data Types, Cross-Platform Issues" |
