...
| --- | --- | --- | --- | --- | --- | --- |
| FIO10-J | Low | Unlikely | No | No | <span style="color: #27ae60;">**P1**</span> | <span style="color: #27ae60;">**L3**</span> |

## Automated Detection

| Tool      | Version  | Checker | Description |
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.FIO10.NASSIGIO** | Ensure the return values of specified file I/O methods are used |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/sonarqube">SonarQube</a> | <div class="content-wrapper">9.9</div> | **<a href="https://www.sonarsource.com/products/codeanalyzers/sonarjava/rules.html#RSPEC-2674">S2674</a>** |  |
...
|                                    |                                                                                                               |
|------------------------------------|---------------------------------------------------------------------------------------------------------------|
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-135](https://cwe.mitre.org/data/definitions/135.html) , Incorrect Calculation of Multi-byte String Length |

## Bibliography

|  |  |
| --- | --- |
| \[ [API 2006](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-API06) \] | [Class `InputStream`](https://docs.oracle.com/javase/8/docs/api/java/io/InputStream.html) [Class `DataInputStream`](https://docs.oracle.com/javase/8/docs/api/java/io/DataInputStream.html) |
| \[ [Chess 2007](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Chess07) \] | Section 8.1, "Handling Errors with Return Codes" |
| \[ [Harold 1999](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Harold99) \] | Chapter 7, "Data Streams, Reading Byte Arrays" |
