...
<table class="wrapped"><tbody><tr class="header"><th>Tool</th><th>Version</th><th>Checker</th><th>Description</th></tr><tr class="odd"><td><a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a></td><td><div class="content-wrapper">2026.1</div></td><td><strong>CERT.FIO07.EXEC<br/>CERT.FIO07.PBIOS</strong></td><td>Do not use 'Runtime.exec()'<br/>Prevent external processes from blocking on input and output streams</td></tr></tbody></table>
