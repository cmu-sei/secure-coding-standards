...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/klocwork">Klocwork</a> | <div class="content-wrapper">2025.2</div> | **SV.HTTP_SPLITSV.SSRF.URI** |  |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.ERR03.REVOBJ** | Restore prior object state on method failure |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **PEHThrow** | Full Implementation |


## Related Vulnerabilities

[CVE-2008-0002](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-0002) describes a [vulnerability](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-bb-glossary#RuleBB.Glossary-vul) in several versions of Apache Tomcat. If an exception occurs during parameter processing, the program can be left in the context of the wrong request, which might allow remote attackers to obtain sensitive information. An exception can be triggered by disconnecting from Tomcat during this processing.

## Related Guidelines

|                                    |                                                                                                  |
|------------------------------------|--------------------------------------------------------------------------------------------------|
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-460](https://cwe.mitre.org/data/definitions/460.html) , Improper Cleanup on Thrown Exception |
