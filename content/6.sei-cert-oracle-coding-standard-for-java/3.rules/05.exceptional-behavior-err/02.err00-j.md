...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.0p0</div> | **JAVA.STRUCT.EXCP.EEH** | Empty Exception Handler (Java) |
...
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2025.2</div> | **CERT.ERR00.LGE** <br /> **CERT.ERR00.UCATCH** | Ensure all exceptions are either logged with a standard logger or rethrown <br /> Use a caught exception in the "catch" block |
