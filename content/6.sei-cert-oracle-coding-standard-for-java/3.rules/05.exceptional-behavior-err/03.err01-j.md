...
| --- | --- |
|  |  |
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-209](https://cwe.mitre.org/data/definitions/209.html) , Information Exposure through an Error Message<br>[CWE-497](https://cwe.mitre.org/data/definitions/497.html) , Exposure of System Data to an Unauthorized Control Sphere<br>[CWE-600](https://cwe.mitre.org/data/definitions/600.html) , Uncaught Exception in Servlet |
