...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/the-checker-framework">The Checker Framework</a> | <div class="content-wrapper">2.1.3</div> | **Lock Checker** | Concurrency and lock errors (see Chapter 6) |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **JAVA.CONCURRENCY.LOCK.ISTR** | Synchronization on Interned String (Java) |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.LCK00.SOPF** | Do not synchronize on "public" fields since doing so may cause deadlocks |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/sonarqube">SonarQube</a> | <div class="content-wrapper">9.9</div> | **<a href="https://www.sonarsource.com/products/codeanalyzers/sonarjava/rules.html#RSPEC-2445">S2445</a>** |  |


## Related Guidelines

<table class="wrapped"><tbody><tr class="odd"><td><p><a href="https://cwe.mitre.org/">MITRE CWE</a></p></td><td><p><a href="https://cwe.mitre.org/data/definitions/412.html">CWE-412</a> . Unrestricted externally accessible lock</p></td></tr><tr class="even"><td><p><br />
</p></td><td><p><a href="https://cwe.mitre.org/data/definitions/413.html">CWE-413</a> . Improper resource locking</p></td></tr></tbody></table>
