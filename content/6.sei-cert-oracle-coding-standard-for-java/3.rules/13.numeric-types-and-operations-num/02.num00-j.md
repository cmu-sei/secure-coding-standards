...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.0p0</div> | **JAVA.MATH.ABSRAND** <br /> **JAVA.ARITH.OFLOW** | Abs on random <br /> Cast: int computation to long |
...
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2025.2</div> | **CERT.NUM00.ICO** <br /> **CERT.NUM00.BSA** <br /> **CERT.NUM00.CACO** | Avoid calculations which result in overflow or NaN <br /> Do not use an integer outside the range of [0, 31] as the amount of a shift <br /> Avoid using compound assignment operators in cases which may cause overflow |
