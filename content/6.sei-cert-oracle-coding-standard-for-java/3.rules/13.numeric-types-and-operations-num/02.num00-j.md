...
Programs must not allow mathematical operations to exceed the integer ranges provided by their primitive integer data types. According to *The Java Language Specification* (JLS), [§4.2.2, "Integer Operations"](https://docs.oracle.com/javase/specs/jls/se8/html/jls-4.html#jls-4.2.2) \[ [JLS 2015](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JLS15) \]:
...
The integral types in Java, representation, and inclusive ranges are shown in the following table taken from the JLS, [§4.2.1, "Integral Types and Values"](https://docs.oracle.com/javase/specs/jls/se8/html/jls-4.html#jls-4.2.1) \[ [JLS 2015](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JLS15) \]:
...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/codesonar">CodeSonar</a> | <div class="content-wrapper">9.2p0</div> | **JAVA.MATH.ABSRAND** <br /> **JAVA.ARITH.OFLOW** | Abs on random <br /> Cast: int computation to long |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/coverity">Coverity</a> | 7.5 | **BAD_SHIFT** <br /> **OVERFLOW_BEFORE_WIDEN** | Implemented |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/klocwork">Klocwork</a> | <div class="content-wrapper">2025.2</div> | **SV.INT_OVF** |  |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.NUM00.ICO** <br /> **CERT.NUM00.BSA** <br /> **CERT.NUM00.CACO** | Avoid calculations which result in overflow or NaN <br /> Do not use an integer outside the range of [0, 31] as the amount of a shift <br /> Avoid using compound assignment operators in cases which may cause overflow |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/pvs-studio">PVS-Studio</a> | <div class="content-wrapper">7.43</div> | **<a href="https://pvs-studio.com/en/docs/warnings/v5308/">V5308</a> , <a href="https://pvs-studio.com/en/docs/warnings/v6117/">V6117</a> , <a href="https://pvs-studio.com/en/docs/warnings/v6130/">V6130</a> , <a href="https://pvs-studio.com/en/docs/warnings/v6131/">V6131</a>** |  |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **IntegerOverflow** | Full Implementation |


Related Guidelines

<table class="wrapped"><tbody><tr class="odd"><td><p><a href="/sei-cert-c-coding-standard/">SEI CERT C Coding Standard</a></p></td><td><p><a href="/sei-cert-c-coding-standard/rules/integers-int/int32-c">INT32-C. Ensure that operations on signed integers do not result in overflow</a></p></td></tr><tr class="even"><td><a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-ISO/IECTR24772-2010">ISO/IEC TR 24772:2010</a></td><td><p>Wrap-around Error [XYY]</p></td></tr><tr class="odd"><td><p><a href="https://cwe.mitre.org/">MITRE CWE</a></p></td><td><p><a href="https://cwe.mitre.org/data/definitions/682.html">CWE-682</a> , Incorrect Calculation<br />
<a href="https://cwe.mitre.org/data/definitions/190.html">CWE-190</a> , Integer Overflow or Wraparound<br />
<a href="https://cwe.mitre.org/data/definitions/191.html">CWE-191</a> , Integer Underflow (Wrap or Wraparound)</p></td></tr></tbody></table>
...
|  |  |
| --- | --- |
| \[ [API 2006](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-API06) \] | Class [`AtomicInteger`](http://download.oracle.com/javase/6/docs/api/java/util/concurrent/atomic/AtomicInteger.html) |
| \[ [Bloch 2005](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Bloch05) \] | Puzzle 27, "Shifty i's" |
| \[ [Bloch 2008](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Bloch08) \] | Item 12, " Minimize the Accessibility of Classes and Members " |
| \[ [Java Tutorials](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Tutorials08) \] | [Primitive Data Types](https://docs.oracle.com/javase/tutorial/java/nutsandbolts/datatypes.html) |
| \[ [JLS 2015](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JLS15) \] | [§4.2.1, "Integral Types and Values"](https://docs.oracle.com/javase/specs/jls/se8/html/jls-4.html#jls-4.2.1) [§4.2.2, "Integer Operations"](https://docs.oracle.com/javase/specs/jls/se8/html/jls-4.html#jls-4.2.2) [§15.22, "Bitwise and Logical Operators"](https://docs.oracle.com/javase/specs/jls/se8/html/jls-15.html#jls-15.22) |
| \[ [Seacord 2005](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Seacord05) \] | Chapter 5, "Integers" |
