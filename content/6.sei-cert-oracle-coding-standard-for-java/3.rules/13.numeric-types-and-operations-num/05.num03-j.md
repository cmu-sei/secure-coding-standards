...
|  |  |
| --- | --- |
| \[ [API 2006](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-API06) \] | Class `DataInputStream` : method `readInt` |
| \[ [Harold 1997](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Harold97) \] | Chapter 2, "Primitive Data Types, Cross-Platform Issues, Unsigned Integers" |
| \[ [Hitchens 2002](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Hitchens02) \] | Section 2.4.5, "Accessing Unsigned Data" |
| \[ [Seacord 2015](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Seacord2015) \] | ![](https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcR5qEGh3iWVRSYkilqOBtCNr8FE15PosscXUuQBpnw67nRbPOcCyQ) [NUM03-J. Use integer types that can fully represent the possible range of unsigned data](https://www.safaribooksonline.com/library/view/secure-coding-rules/9780134031521/part23.html) LiveLesson |
