...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2025.2</div> | **CERT.NUM01.BADSHIFT** <br /> **CERT.NUM01.NCBAV** | Avoid incorrect shift operations <br /> Do not perform bitwise and arithmetic operations on the same data |
