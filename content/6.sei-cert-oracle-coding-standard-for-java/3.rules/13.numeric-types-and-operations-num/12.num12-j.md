...
Java provides 22 possible *narrowing primitive conversions* . According to *The Java Languagee Specification* (JLS), [§5.1.3, "Narrowing Primitive Conversions"](https://docs.oracle.com/javase/specs/jls/se8/html/jls-5.html#jls-5.1.3) \[ [JLS 2015](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JLS05) \]:
...
See the JLS, [§5.1.3, "Narrowing Primitive Conversions"](https://java.sun.com/docs/books/jls/third_edition/html/conversions.html#5.1.3) \[ [JLS 2005](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JLS05) \], for more information.

### Other Conversions

Narrower primitive types can be cast to wider types without affecting the magnitude of numeric values (see the JLS, [§5.1.2, Widening Primitive Conversion"](https://java.sun.com/docs/books/jls/third_edition/html/conversions.html#5.1.2) \[ [JLS 2005](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JLS05) \]), for more information). Conversion from `int` or `long` to `float` or from `long` to `double` can lead to loss of precision (loss of least significant bits). No runtime exception occurs despite this loss.
