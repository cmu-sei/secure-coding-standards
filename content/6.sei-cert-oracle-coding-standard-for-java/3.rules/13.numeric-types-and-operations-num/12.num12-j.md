...
|  |  |
| --- | --- |
| [SEI CERT C Coding Standard](/sei-cert-c-coding-standard/) | [INT31-C. Ensure that integer conversions do not result in lost or misinterpreted data](/sei-cert-c-coding-standard/rules/integers-int/int31-c)<br>[FLP34-C. Ensure that floating-point conversions are within range of the new type](/sei-cert-c-coding-standard/rules/floating-point-flp/flp34-c) |
| [ISO/IEC TR 24772:2010](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-ISO/IECTR24772-2010) | Numeric Conversion Errors [FLC] |
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-681](https://cwe.mitre.org/data/definitions/681.html) , Incorrect Conversion between Numeric Types<br>[CWE-197](https://cwe.mitre.org/data/definitions/197.html) , Numeric Truncation Error |
