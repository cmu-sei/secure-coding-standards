...
|  |  |
| --- | --- |
| [MITRE CWE](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-MITRE09) | [CWE-498](https://cwe.mitre.org/data/definitions/498.html) , Cloneable Class Containing Sensitive Information<br>[CWE-491](https://cwe.mitre.org/data/definitions/491.html) , Public `cloneable()` Method without Final (aka "Object Hijack") |
