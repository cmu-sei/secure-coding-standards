...
|  |  |
| --- | --- |
| [MITRE CWE](https://cwe.mitre.org/) | [CWE-374](https://cwe.mitre.org/data/definitions/374.html) , Passing Mutable Objects to an Untrusted Method<br>[CWE-375](https://cwe.mitre.org/data/definitions/375.html) , Returning a Mutable Object to an Untrusted Caller |
| [Secure Coding Guidelines for Java SE, Version 5.0](https://www.oracle.com/technetwork/java/seccodeguide-139067.html) | Guideline 6-4 / MUTABLE-4: Support copy functionality for a mutable class |
