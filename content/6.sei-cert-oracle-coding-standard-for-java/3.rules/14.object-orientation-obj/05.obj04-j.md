...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/coverity">Coverity</a> | 7.5 | **FB.EI_EXPOSE_REP2** <br /> **FB.EI_EXPOSE_REP** | Implemented |
...
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.OBJ04.CLONE** <br /> **CERT.OBJ04.CPCL** <br /> **CERT.OBJ04.MPT** <br /> **CERT.OBJ04.SMOC** <br /> **ERT.OBJ04.MUCOP** | Make your 'clone()' method "final" for security <br /> Enforce returning a defensive copy in 'clone()' methods <br /> Do not pass user-given mutable objects directly to certain types <br /> Do not store user-given mutable objects directly into variables <br /> Provide mutable classes with copy functionality |


## Related Guidelines

<table class="wrapped"><tbody><tr class="odd"><td><p><a href="https://cwe.mitre.org/">MITRE CWE</a></p></td><td><p><a href="https://cwe.mitre.org/data/definitions/374.html">CWE-374</a> , Passing Mutable Objects to an Untrusted Method<br />
<a href="https://cwe.mitre.org/data/definitions/375.html">CWE-375</a> , Returning a Mutable Object to an Untrusted Caller</p></td></tr><tr class="even"><td><p><a href="https://www.oracle.com/technetwork/java/seccodeguide-139067.html">Secure Coding Guidelines for Java SE, Version 5.0</a></p></td><td><p>Guideline 6-4 / MUTABLE-4: Support copy functionality for a mutable class</p></td></tr></tbody></table>

## Bibliography

<table class="wrapped"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td><p>[ <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-API14">API 2014</a> ]</p></td><td><p><a href="https://docs.oracle.com/javase/8/docs/api/">Method <code>        clone()       </code></a></p></td></tr><tr class="even"><td><p>[ <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Bloch08">Bloch 2008</a> ]</p></td><td><p>Item 39, "Make Defensive Copies When Needed"<br />
