...
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2025.2</div> | **CERT.OBJ04.CLONE** <br /> **CERT.OBJ04.CPCL** <br /> **CERT.OBJ04.MPT** <br /> **CERT.OBJ04.SMOC** <br /> **ERT.OBJ04.MUCOP** | Make your 'clone()' method "final" for security <br /> Enforce returning a defensive copy in 'clone()' methods <br /> Do not pass user-given mutable objects directly to certain types <br /> Do not store user-given mutable objects directly into variables <br /> Provide mutable classes with copy functionality |
