...
Heap pollution occurs when a variable of a parameterized type references an object that is not of that parameterized type. (For more information on heap pollution, see *The Java Language Specification* (JLS), [§4.12.2, "Variables of Reference Type"](https://docs.oracle.com/javase/specs/jls/se8/html/jls-4.html#jls-4.12.2) \[ [JLS 2015](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JLS15) \].)
...
In some cases, it is possible that a compile-time unchecked warning will not be generated. According to the JLS, [§4.12.2,](https://java.sun.com/docs/books/jls/third_edition/html/typesValues.html#111088) ["Variables of Reference Type"](https://docs.oracle.com/javase/specs/jls/se8/html/jls-4.html#jls-4.12.2) \[ [JLS 2015](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JLS15) \]:
...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.OBJ03.AGBPT** | Avoid conversions from parameterized types to raw types |
...
|  |  |
| --- | --- |
| \[ [Bloch 2008](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Bloch08) \] | Item 23, "Don't Use Raw Types in New Code" |
| \[ [Bloch 2007](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Bloch07) \] |  |
| \[ [Bloch 2005](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Bloch05) \] | Puzzle 88, "Raw Deal" |
| \[ [Darwin 2004](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Darwin04) \] | Section 8.3, "Avoid Casting by Using Generics" |
| \[ [JavaGenerics 2004](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JavaGenerics04) \] |  |
| \[ [Java Tutorials](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JavaTutorials) \] | ["Heap Pollution"](https://docs.oracle.com/javase/tutorial/java/generics/nonReifiableVarargsType.html#heap_pollution) |
| \[ [JLS 2015](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-JLS15) \] | [§4.8, "Raw Types"](https://docs.oracle.com/javase/specs/jls/se8/html/jls-4.html#jls-4.8) [§4.12.2, "Variables of Reference Type"](https://docs.oracle.com/javase/specs/jls/se8/html/jls-4.html#jls-4.12.2) [ Chapter 5, "Conversions and Promotions"](https://docs.oracle.com/javase/specs/jls/se8/html/jls-5.html) [§5.1.9, "Unchecked Conversion"](https://docs.oracle.com/javase/specs/jls/se8/html/jls-5.html#jls-5.1.9) |
| \[ [Langer 2008](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Langer08) \] | Topic 3, ["Coping with Legacy"](http://www.angelikalanger.com/GenericsFAQ/FAQSections/ProgrammingIdioms.html#Topic3) |
| \[ [Naftalin 2006](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Naftalin06) \] | Chapter 8, "Effective Generics" |
| \[ [Naftalin 2006b](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Naftalin06b) \] | "Principle of Indecent Exposure" |
| \[ [Schildt 2007](/sei-cert-oracle-coding-standard-for-java/back-matter/rule-aa-references#RuleAA.References-Schildt07) \] | "Create a Checked Collection" |
