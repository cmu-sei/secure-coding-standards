...
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.IDS51.TDRESP** <br /> **CERT.IDS51.TDXSS** | Protect against HTTP response splitting <br /> Protect against XSS vulnerabilities |


### Related Vulnerabilities

The Apache [GERONIMO-1474](https://issues.apache.org/jira/browse/GERONIMO-1474) vulnerability, reported in January 2006, allowed attackers to submit URLs containing JavaScript. The Web Access Log Viewer failed to sanitize the data it forwarded to the administrator console, thereby enabling a classic XSS attack.

## Bibliography

<table class="wrapped"><tbody><tr class="odd"><td>[ <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-OWASP11">OWASP 2011</a> ]</td><td><a href="https://www.owasp.org/index.php/Cross-site_Scripting_%28XSS%29">Cross-site Scripting (XSS)</a></td></tr><tr class="even"><td>[ <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-OWASP14">OWASP 2014</a> ]</td><td><a href="https://www.owasp.org/index.php/How_to_add_validation_logic_to_HttpServletRequest">How to Add Validation Logic to HttpServletRequest</a><br />
<a href="https://www.owasp.org/index.php/XSS_%28Cross_Site_Scripting%29_Prevention_Cheat_Sheet#Escaping_.28aka_Output_Encoding.29">XSS (Cross-Site Scripting) Prevention Cheat Sheet</a></td></tr></tbody></table>
