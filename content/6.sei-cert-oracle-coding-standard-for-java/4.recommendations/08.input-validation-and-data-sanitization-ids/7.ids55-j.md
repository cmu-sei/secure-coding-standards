...
|  |  |
| --- | --- |
| \[ [API 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-API13) \] | [Class Pattern,](https://docs.oracle.com/javase/7/docs/api/java/util/regex/Pattern.html) "Backslashes, Escapes, and Quoting" [Package `java.sql`](https://docs.oracle.com/javase/7/docs/api/java/sql/package-frame.html) |
| \[ [JLS 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-JLS13) \] | [§3.10.6, "Escape Sequences for Character and String Literals"](https://docs.oracle.com/javase/specs/jls/se7/html/jls-3.html#jls-3.10.6) |
