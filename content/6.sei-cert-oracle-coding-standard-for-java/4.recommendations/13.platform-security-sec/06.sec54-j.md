...
|  |  |
| --- | --- |
| \[ [API 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-API13) \] | Class `SecurityManager` Class `AccessControlContext` Class `AccessController` |
| \[ [Gong 2003](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Gong03) \] | §6.1, "Security Manager" |
| \[ [Pistoia 2004](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Pistoia04) \] | §7.4, "The Security Manager" |
| \[ [Policy 2010](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Policy02) \] | Default Policy Implementation and Policy File Syntax |
| \[ [SecuritySpec 2010](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-SecuritySpec08) \] | §6.2, " `SecurityManager` versus `AccessController` " |
