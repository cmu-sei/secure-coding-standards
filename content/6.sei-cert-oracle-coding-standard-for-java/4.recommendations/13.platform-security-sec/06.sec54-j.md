...
According to the Java API [Class `SecurityManager`](https://docs.oracle.com/javase/7/docs/api/java/lang/SecurityManager.html) documentation \[ [API 2014](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-API11) \],
