...
|  |  |
| --- | --- |
| \[ [API 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-API13) \] | [Class FilePermission](https://docs.oracle.com/javase/7/docs/api/java/io/FilePermission.html) [Class SecurityManager](https://docs.oracle.com/javase/7/docs/api/java/lang/SecurityManager.html) |
| \[ [Oaks 2001](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Oaks01) \] | Chapter 5, "The Access Controller," "Permissions" |
| \[ [Oracle 2011d](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Oracle11) \] | [Permissions in the Java™ SE 6 Development Kit (JDK)](https://docs.oracle.com/javase/6/docs/technotes/guides/security/permissions.html) |
| \[ [Oracle 2013c](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Oracle13c) \] | [Permissions in Java SE 7 Development Kit (JDK)](https://docs.oracle.com/javase/7/docs/technotes/guides/security/permissions.html) |
| \[ [Policy 2010](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Policy02) \] | "Permission Descriptions and Risks" |
