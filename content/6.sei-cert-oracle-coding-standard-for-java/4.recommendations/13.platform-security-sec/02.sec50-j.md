...
|                                                                                                                           |                                                                                                                       |
|---------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
| \[ [API 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-API11) \]         | [Class `AccessController`](https://docs.oracle.com/javase/7/docs/api/java/security/AccessController.html) |
| \[ [Oracle 2012a](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Oracle12a) \] | [API for Privileged Blocks](https://download.java.net/jdk8/docs/technotes/guides/security/doprivileged.html)           |
