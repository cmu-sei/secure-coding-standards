...
According to the Java API, [Class Enum\<E extends Enum\<E>\>](https://docs.oracle.com/javase/7/docs/api/java/lang/Enum.html) \[ [API 2011](https://www.securecoding.cert.org/confluence/display/jg/AA.+References#AAReferences-API11) \], `   public final int ordinal()  `
...
|                                                                                                                       |                                                                                                                |
|-----------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
| \[ [API 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-API11) \]     | [Class `        Enum<E extends Enum<E>>       `](https://docs.oracle.com/javase/7/docs/api/java/lang/Enum.html) |
