...
This noncompliant code example attempts to use the volatile-read, synchronized-write technique described in [Java Theory and Practice](https://www.ibm.com/developerworks/java/library/j-jtp06197.html) \[ [Goetz 2007](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Goetz07) \]. The `map` field is declared volatile to synchronize its reads and writes. The `put()` method is also synchronized to ensure that its statements are executed atomically.
...
|                                                                                                                         |                                                                                                                          |
|-------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|
| \[ [API 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-API13) \]       | [Class `DateFormat`](https://docs.oracle.com/javase/7/docs/api/java/text/DateFormat.html)                  |
