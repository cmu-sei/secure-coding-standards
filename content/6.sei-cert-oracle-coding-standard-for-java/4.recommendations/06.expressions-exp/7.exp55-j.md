...
The conditional operator `?:` uses the `boolean` value of its first operand to decide which of the other two expressions will be evaluated. (See [§15.25, "Conditional Operator `    ? :   ` "](https://docs.oracle.com/javase/specs/jls/se7/html/jls-15.html#jls-15.25) of the *Java Language Specification* (JLS) \[ [JLS 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-JLS13) \].)
...
| \[ [JLS 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-JLS13) \]           | [§15.25, "Conditional Operator `       ? :      ` "](https://docs.oracle.com/javase/specs/jls/se7/html/jls-15.html#jls-15.25) |
