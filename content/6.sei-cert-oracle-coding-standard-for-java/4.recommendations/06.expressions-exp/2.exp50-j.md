...
|  |  |
| --- | --- |
| \[ [Bloch 2008](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Bloch08) \] | Item 69, "Prefer Concurrency Utilities to `wait` and `notify` " |
| \[ [FindBugs 2008](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-FindBugs08) \] | ES, "Comparison of String Objects Using `==` or `!=` " |
| \[ [JLS 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-JLS13) \] | [§3.10.5, "String Literals" ](https://docs.oracle.com/javase/specs/jls/se7/html/jls-3.html#jls-3.10.5) [§5.6.2, "Binary Numeric Promotion"](https://docs.oracle.com/javase/specs/jls/se7/html/jls-5.html#jls-5.6.2) |
