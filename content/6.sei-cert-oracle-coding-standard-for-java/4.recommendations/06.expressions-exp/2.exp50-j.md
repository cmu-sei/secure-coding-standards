...
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/the-checker-framework">The Checker Framework</a> | <div class="content-wrapper">2.1.3</div> | **Interning Checker** | Check for errors in equality testing and interning (see Chapter 5) |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.EXP50.UEIC** | Do not use '==' or '!=' to compare objects |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/sonarqube">SonarQube</a> | <div class="content-wrapper">9.9</div> | **<a href="https://www.sonarsource.com/products/codeanalyzers/sonarjava/rules.html#RSPEC-1698">S1698</a>** |  |


## Bibliography

<table class="wrapped"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td>[ <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Bloch08">Bloch 2008</a> ]</td><td>Item 69, "Prefer Concurrency Utilities to <code>      wait     </code> and <code>      notify     </code> "</td></tr><tr class="even"><td><p>[ <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-FindBugs08">FindBugs 2008</a> ]</p></td><td><p>ES, "Comparison of String Objects Using <code>       ==      </code> or <code>       !=      </code> "</p></td></tr><tr class="odd"><td><p>[ <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-JLS13">JLS 2013</a> ]</p></td><td><p><a href="https://docs.oracle.com/javase/specs/jls/se7/html/jls-3.html#jls-3.10.5">§3.10.5, "String Literals"<br />
</a> <a href="https://docs.oracle.com/javase/specs/jls/se7/html/jls-5.html#jls-5.6.2">§5.6.2, "Binary Numeric Promotion"</a></p></td></tr></tbody></table>
