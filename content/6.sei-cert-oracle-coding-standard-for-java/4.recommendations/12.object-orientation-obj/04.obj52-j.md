...
The Apache Geronimo and Tomcat vulnerability [GERONIMO-4574](https://issues.apache.org/jira/browse/GERONIMO-4574) , reported in March 2009, resulted from `PolicyContext` handler data objects being set in a thread and never released, causing these data objects to remain in memory longer than necessary.

## Bibliography

|                                                                                                                           |                                                                                                                                                  |
|---------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| \[ [API 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-API13) \]         | [Class `System`](https://docs.oracle.com/javase/7/docs/api/java/lang/System.html)                                                  |
...
| \[ [Goetz 2004](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Goetz04) \]     | [Java Theory and Practice: Garbage Collection and Performance](https://www.ibm.com/developerworks/java/library/j-jtp01274.html)                   |
...
| \[ [Oracle 2010a](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Oracle10a) \] | [Java SE 6 HotSpot™ Virtual Machine Garbage Collection Tuning](https://www.oracle.com/technetwork/java/javase/gc-tuning-6-140523.html)            |
