...
Weak cryptographic algorithms can be disabled in Java SE 7; see the [Java PKI Programmer's Guide, Appendix D: Disabling Cryptographic Algorithms](https://docs.oracle.com/javase/7/docs/technotes/guides/security/certpath/CertPathProgGuide.html#AppD) \[ [Oracle 2011a](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Oracle11a) \].

## Automated Detection

| Tool      | Version  | Checker | Description |
|-----------|----------|---------|-------------|
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/parasoft">Parasoft Jtest</a> | <div class="content-wrapper">2026.1</div> | **CERT.MSC61.AISSAJAVA** <br /> **CERT.MSC61.AISSAXML** <br /> **CERT.MSC61.HCCK** <br /> **CERT.MSC61.ICA** <br /> **CERT.MSC61.CKTS** | Avoid using insecure cryptographic algorithms for data encryption with Spring <br /> Avoid using insecure cryptographic algorithms in Spring XML configurations <br /> Avoid using hard-coded cryptographic keys <br /> Avoid using insecure algorithms for cryptography <br /> Avoid using cryptographic keys which are too short |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/security-reviewer-static-reviewer">Security Reviewer - Static Reviewer</a> | <div class="content-wrapper">6.02</div> | **Ics06** | Full Implementation |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/sonarqube">SonarQube</a> | <div class="content-wrapper">9.9</div> | **<a href="https://www.sonarsource.com/products/codeanalyzers/sonarjava/rules.html#RSPEC-2278">S2278</a>** |  |
| <a href="/sei-cert-oracle-coding-standard-for-java/back-matter/rule-or-rec-cc-analyzers/pvs-studio">PVS-Studio</a> | <div class="content-wrapper">7.43</div> | **<a href="https://pvs-studio.com/en/docs/warnings/v5313/">V5313</a> , <a href="https://pvs-studio.com/en/docs/warnings/v5314/">V5314</a> , <a href="https://pvs-studio.com/en/docs/warnings/v5315/">V5315</a>** |  |
...
|                                                                                                                           |                                                                                                                                                       |
|---------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
| \[ [Oracle 2011a](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Oracle11a) \] | [Appendix D: Disabling Cryptographic Algorithms](https://docs.oracle.com/javase/7/docs/technotes/guides/security/certpath/CertPathProgGuide.html#AppD) |
| \[ [Oracle 2013b](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Oracle13b) \] | [Java Cryptography Architecture (JCA) Reference Guide](https://docs.oracle.com/javase/7/docs/technotes/guides/security/crypto/CryptoSpec.html)         |
