...
| \[ [Oracle 2013b](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Oracle13b) \]     | [Reading ASCII Passwords from an `InputStream` Example](https://docs.oracle.com/javase/7/docs/technotes/guides/security/crypto/CryptoSpec.html#ReadPassword) (Java Cryptography Architecture \[JCA\] Reference Guide) |
