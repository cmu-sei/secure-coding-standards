...
According to the Java API [Interface Enumeration\<E>](https://docs.oracle.com/javase/7/docs/api/java/util/Enumeration.html) documentation \[ [API 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-API13) \],
...
According to the Java API [Interface Iterator\<E>](https://docs.oracle.com/javase/7/docs/api/java/util/Iterator.html) documentation \[ [API 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-API13) \],
