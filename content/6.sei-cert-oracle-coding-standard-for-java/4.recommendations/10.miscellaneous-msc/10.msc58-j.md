...
|  |  |
| --- | --- |
| \[ [API 2013](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-API13) \] | Interface [Enumeration&lt;E&gt; ](https://docs.oracle.com/javase/7/docs/api/java/util/Enumeration.html) Interface [Iterator&lt;E&gt;](https://docs.oracle.com/javase/7/docs/api/java/util/Iterator.html) |
| \[ [Daconta 2003](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-Daconta03) \] | Item 21, "Use Iteration over Enumeration" |
