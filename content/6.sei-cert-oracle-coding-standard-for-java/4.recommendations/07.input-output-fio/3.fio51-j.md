...
|  |  |
| --- | --- |
| \[ [API 2011](/sei-cert-oracle-coding-standard-for-java/back-matter/rec-aa-references#Rec.AA.References-API11) \] | [Class `java.io.File`](http://download.oracle.com/javase/7/docs/api/java/io/File.html) [Interface `java.nio.file.Path`](http://download.oracle.com/javase/7/docs/api/java/nio/file/Path.html) [Class `java.nio.file.Files`](http://download.oracle.com/javase/7/docs/api/java/nio/file/Files.html) [Interface `java.nio.file.attribute.BasicFileAttributes`](http://download.oracle.com/javase/7/docs/api/java/nio/file/attribute/BasicFileAttributes.html) |
